...
{ id:"EC1-Q1", domaine:"Personnes", approche:"Hybride", type:"etude-de-cas",
  ...
  options:[
    `A. Mener d'abord des entretiens individuels séparés avec Kwame et Raj pour identifier les causes factuelles (spécifications incomplètes ? standards ambigus ? communication interculturelle ?), puis organiser une session de résolution structurée à trois avec un cadre d'accord documenté.`,
    `B. Convoquer immédiatement une réunion plénière des 34 membres pour exposer le conflit, obtenir l'avis collectif et décider des standards de qualité — la transparence totale est la meilleure approche multiculturelle.`,
...
{ id:"EC1-Q3", domaine:"Processus", approche:"Hybride", type:"etude-de-cas",
  ...
  options:[
    ...
    `B. Combiner les deux options simultanément pour maximiser les chances de récupération tout en demandant une extension de délai de 2 semaines.`,
    `C. Attendre les résultats du sprint suivant avant d'engager des ressources — la précipitation est l'ennemi de la qualité.`
    `D. Recommander Option X (crashing) après avoir calculé IPC-Cal = 0,80 et IPC-C = 0,89 confirmant dégradation sur deux axes ; EAC recalculé = 4,72 M€ dépasse le BAC ; le crashing à 180 k€ est inférieur à la pénalité de 250 k€/semaine — présenter l'EAC révisé au comité.`,
  ],
  correct:3,
...
{ id:"EC2-Q2", domaine:"Environnement d'affaires", approche:"Hybride", type:"etude-de-cas",
  ...
  options:[
    `A. Proposer un déploiement en 2 phases : Phase 1 dans le délai demandé — modules RH core uniquement (40 % fonctions), formation accélérée ciblée, exclusion du module paie (risque trop élevé). Phase 2 — module paie + formation complète 4 semaines après. Présenter au DRH avec mise à jour formelle du business case et documentation des risques résiduels.`,
    `B. Accepter la directive du DRH sans condition — il a l'autorité finale sur les compromis périmètre/délai/qualité.`,
...
{ id:"P-001", domaine:"Personnes", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Remplacer le représentant qui bloque par quelqu'un de plus coopératif pour débloquer la cérémonie.`,
    `C. Accepter les engagements des autres équipes sans l'équipe Infrastructure et planifier une session de rattrapage la semaine suivante.`
    `D. Suspendre la session 30 min : organiser un breakout avec le tech lead Infrastructure, le Product Manager et vous-même pour examiner les 3 stories les plus contestées ; proposer ensuite soit des stories réduites avec engagement ferme, soit des stories complètes avec flag risque élevé — documenter dans le Program Board.`,
  ],
  correct:3,
...
{ id:"P-003", domaine:"Personnes", approche:"Hybride", type:"standard",
  ...
  options:[
    ...
    `B. Organiser une réunion séparée avec les 8 employés pour collecter leurs préoccupations réelles et les présenter aux consultants en votre nom propre en masquant la source.`,
...
{ id:"P-005", domaine:"Personnes", approche:"Prédictif", type:"standard",
  ...
  options:[
    `A. Rencontrer le responsable du sous-traitant pour comprendre les raisons du refus (incompréhension contractuelle ? manque de ressources ? culture différente de reporting ?), rappeler clairement les obligations contractuelles, proposer un format de reporting simplifié si la complexité est le problème, et si la situation persiste, activer la clause de non-conformité contractuelle avec notification écrite formelle.`,
    `B. Accepter la situation et ajuster votre planning global en ajoutant des tampons pour absorber les incertitudes liées à ce sous-traitant.`,
...
{ id:"P-008", domaine:"Personnes", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Signaler la résistance passive au directeur de l'administration pour qu'il prenne des mesures disciplinaires contre les archivistes non coopératifs.`,
    `C. Remplacer les archivistes dans les formations par des consultants qui peuvent fournir les informations nécessaires au projet sans résistance.`
...
{ id:"P-010", domaine:"Personnes", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Convoquer une réunion de toute l'équipe pour clarifier publiquement la chaîne de commandement et indiquer que seules les instructions du chef de projet doivent être suivies.`,
    `C. Solliciter une réunion privée avec le PDG pour reconnaître son investissement dans le projet, lui expliquer l'impact des instructions directes sur la cohérence du plan et la clarté des rôles pour l'équipe, et proposer un accord clair : il communique ses instructions au chef de projet qui les intègre dans le plan ou les traite comme des demandes de modification — en lui garantissant un accès direct aux informations dont il a besoin via des rapports adaptés.`,
...
{ id:"P-013", domaine:"Personnes", approche:"Agile", type:"standard",
  ...
  options:[
    `A. Identifier que le département pratique le "Cargo Cult Agile" — les rituels Agile existent mais sans les valeurs et principes sous-jacents (collaboration, feedback, amélioration continue, livraison de valeur). Aborder le problème par la compréhension et la conviction plutôt que par la contrainte : faciliter une session sur le "Pourquoi l'Agile ?" avec des exemples concrets, travailler sur une vraie user story avec le format correct (en tant que... je veux... afin de...), conduire une rétrospective avec la technique 5 pourquoi sur un vrai problème récent — et célébrer les premières vraies améliorations.`,,
    `B. Conclure que l'Agile ne convient pas à ce département et recommander un retour à la méthode cascade.`,
...
{ id:"P-017", domaine:"Personnes", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Vérifier si l'erreur de paramètre peut être "corrigée" dans le traitement statistique des données sans recollecte ni amendement — une solution technique qui préserve le calendrier.`,,
    `C. Gérer séparément mais simultanément les dimensions humaine et technique : humaine — rassurer le data manager que les erreurs humaines arrivent et que l'objectif est de comprendre la cause profonde et d'améliorer le processus (entretien individuel de soutien, sans blâme) ; technique — analyser avec l'équipe scientifique les options (recollecte ? amendement de protocole ? les deux données sont-elles récupérables ?) et soumettre l'amendement réglementaire si nécessaire sans délai ; éthique — documenter l'incident de façon complète et transparente dans le dossier de l'étude clinique comme le requiert la réglementation, même si cela retarde l'étude.`,
...
{ id:"P-018", domaine:"Personnes", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Remplacer les bénévoles surmenés par des personnes plus disponibles — le projet a des objectifs à tenir.`,
    `C. Adapter radicalement le cadre au contexte : réduire les cérémonies (mêlées asynchrones 2x/semaine, planification mensuelle plutôt que bimensuelle), adopter Kanban (flux continu sans engagement de sprint) plutôt que Scrum, revoir l'objectif de vélocité à la baisse sur la base de la capacité réelle (12-15 points), célébrer chaque contribution même petite, et revoir les attentes de délai avec le commanditaire de l'association en recalibrant le périmètre sur la capacité réelle — un projet bénévole épuisant perd ses ressources et échoue.`,
...
{ id:"P-021", domaine:"Personnes", approche:"Hybride", type:"standard",
  ...
  options:[
    ...
    `B. Déléguer la gestion de ce conflit au responsable RH et continuer la planification du déploiement en supposant que la présence de l'opérateur sera obtenue.`,
    `C. Ne pas forcer la présence de l'opérateur contre son gré ; analyser avec la direction des opérations les options : (1) inclure formellement cette obligation dans la description de poste et rémunérer en conséquence, (2) trouver un opérateur volontaire (avec prime de nuit), (3) planifier le déploiement dans la fenêtre d'horaire normal mais accepter des contraintes supplémentaires de sécurité, (4) évaluer si un déploiement sans présence d'opérateur est techniquement envisageable avec les automatismes en place — traiter la question par la négociation et la rémunération équitable plutôt que par la contrainte.`,
...
{ id:"P-023", domaine:"Personnes", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Organiser une formation intensive de 2 semaines sur la gestion de projets complexes pour les 3 juniors — la formation résoudra les lacunes identifiées.`,
    `C. Laisser les juniors gérer par eux-mêmes en les soutenant à distance — l'apprentissage par l'expérience est le meilleur développeur de compétences.`
    `D. Mettre en place un système de mentorat structuré : assigner un chef de projet senior comme mentor à chacun des 3 juniors (2 heures hebdomadaires de co-gestion, revue des décisions importantes avant action, debriefing post-réunion) ; simplifier leur charge en retirant 1-2 projets de leur portefeuille et en confiant ces projets à des personnes plus expérimentées ; augmenter la fréquence des revues de leurs projets (hebdomadaire au lieu de mensuel) ; investir dans leur formation ciblée sur leurs lacunes identifiées — tout en fixant des objectifs de développement clairs sur 6 mois.`,
  ],
  correct:3,
...
{ id:"P-024", domaine:"Personnes", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Imposer des revues de code croisées obligatoires en présentant cette décision à toute l'équipe sans préparation préalable avec Jacques — les règles du processus Agile s'appliquent à tous.`,
    `C. Engager une conversation directe et respectueuse avec Jacques pour reconnaître son expertise tout en lui présentant l'impact de son comportement sur la progression et la confiance de l'équipe ; proposer de réorienter son expertise vers le rôle de mentor/tech lead (participation aux revues de code comme formateur, présentation des décisions d'architecture à l'équipe avec explication, sessions de pair programming) — en faisant de son expertise un multiplicateur pour l'équipe plutôt qu'un facteur d'exclusion.`,
...
{ id:"P-026", domaine:"Personnes", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Demander au membre de s'excuser publiquement auprès des parties prenantes pour son comportement non professionnel.`,
...
{ id:"P-027", domaine:"Personnes", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Organiser une formation technique intensive pour les ingénieurs internes en fin de projet pour accélérer le transfert de connaissances avant la clôture.`,
    `C. Inclure dans le contrat des consultants une clause de transfert de compétences avec des indicateurs mesurables pour s'assurer qu'ils forment correctement les ingénieurs internes.`
    `D. Reconnaître que ce comportement signale un risque majeur de transfert de compétences — les ingénieurs internes n'acquièrent pas la maîtrise du système qu'ils devront maintenir. Restructurer la dynamique : assigner des responsabilités de décision techniques aux ingénieurs internes (avec support des consultants, pas à leur place), créer des ateliers de co-conception où les ingénieurs internes sont responsables des livrables techniques, exiger que toute documentation soit rédigée par les ingénieurs internes (avec revue des consultants) — transformer les ingénieurs internes de spectateurs en acteurs principaux.`,
  ],
  correct:3,
...
{ id:"P-029", domaine:"Personnes", approche:"Hybride", type:"standard",
  ...
  options:[
    ...
    `B. Demander à un communicant externe de préparer et animer la prochaine démonstration — les ingénieurs ne sont pas les mieux placés pour communiquer avec les élus.`,
    `C. Reconnaître que l'équipe a présenté la solution du point de vue de l'ingénieur alors que les élus ont besoin du point de vue du citoyen : restructurer la prochaine démonstration autour de scénarios concrets, associer les ingénieurs à la préparation de ces scénarios pour transformer leur compréhension technique en bénéfices tangibles, et inviter des citoyens comme observateurs.`,
...
{ id:"P-030", domaine:"Personnes", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Remplir le rapport avec des estimations approximatives pour réduire le temps passé — la précision n'est pas critique pour un rapport d'avancement.`,
    `C. Demander une exemption formelle pour votre équipe Agile en argumentant que les projets Agile ne peuvent pas produire les métriques demandées par le format prédictif.`
    `D. Construire un cas d'affaires montrant le coût du rapport actuel (6-8h/semaine = 300-400h/an pour votre équipe seule) et le proposant en remplacement un format adapté à l'Agile (dashboard d'une page : vélocité, burn-down, prochaines milestones, risques, décisions nécessaires) qui répond aux mêmes besoins d'information de la direction en moins de 2h ; présenter la proposition à votre management et au PMO avec l'objectif d'améliorer le reporting Agile pour toutes les équipes concernées.`,
  ],
  correct:3,
...
{ id:"EC3-Q1", domaine:"Processus", approche:"Prédictif", type:"etude-de-cas",
  ...
  options:[
    `A. Informer immédiatement le DGS et le comité de pilotage de la totalité des faits, initier une demande de modification rétroactive au CCM pour les dépenses justifiables, identifier les ajustements de contrôle interne pour éviter toute récurrence, préparer un rapport complet avec actions correctives — sans minimiser ni retarder la divulgation.`,
    `B. Mandater une investigation interne pour identifier le responsable avant de communiquer — comprendre les faits avant d'exposer le programme à des sanctions politiques.`,
...
{ id:"EC3-Q2", domaine:"Processus", approche:"Hybride", type:"etude-de-cas",
  ...
  options:[
    ...
    `B. Choisir Option C (acceptation) car c'est la solution la moins coûteuse et la plus rapide — les citoyens comprennent les limites de l'IoT.`,
    `C. Engager une analyse contractuelle formelle pour déterminer la responsabilité ; soumettre une demande de modification au CCM avec analyse coût-bénéfice-risque des trois options ; recommander une solution hybride (correction logicielle immédiate + clause de remplacement progressif si les seuils ne sont pas atteints) ; maintenir l'utilisation des données avec indicateur de fiabilité transparent.`,
...
{ id:"PR-001", domaine:"Processus", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. IPC-Cal = 0,84 ; IPC-C = 0,875 ; EAC = 32 M€. Recommandation : suspendre 20 % des activités non critiques pour ramener l'IPC-C à 1,0 — la maîtrise du coût est prioritaire sur le calendrier.`,
    `C. IPC-Cal = 0,84 ; IPC-C = 0,875 ; EAC = 32 M€. Recommandation : ne pas alerter le comité — les déviations de ±15 % sont dans la norme et peuvent se corriger seules.`
    `D. IPC-Cal = 0,84 ; IPC-C = 0,875 ; EAC = 32 M€. Recommandation : présenter l'EAC révisé à 32 M€ au comité (dépassement de 4 M€) ; concentrer les actions correctives sur la réduction des coûts administratifs compressibles ; ne pas comprimer le calendrier des essais ; évaluer si l'IPA (environ 1,11) est atteignable ou si une révision du BAC est nécessaire.`,
  ],
  correct:3,
...
{ id:"PR-006", domaine:"Processus", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Recommander Option C (restriction d'étiquetage) pour permettre un lancement rapide sur certains marchés et planifier la correction PCB dans la version 2.0.`,
    `C. Suspendre le projet et consulter un expert FDA externe avant toute décision — l'enjeu réglementaire dépasse les responsabilités du chef de projet.`
    `D. Recommander Option A (refonte PCB) : la FDA réglemente selon des seuils stricts (2 % maximum), pas des approximations — un taux de 2,1-2,4 % entraîne le rejet de la certification 510(k) avec très haute probabilité ; l'Option C est médicalement inacceptable (humidité élevée fréquente en milieu clinique) ; l'analyse VME montre qu'Option A (380 k€ + 14 sem.) est économiquement dominante sur le cycle complet vs Option B (45 k€ + risque refus FDA = 6-12 mois de retard + refonte de toute façon).`,
  ],
  correct:3,
...
{ id:"PR-007", domaine:"Processus", approche:"Prédictif", type:"standard",
  ...
  options:[
    `A. Conduire une analyse contractuelle distinguant les retards liés aux changements de spécifications (2 cas — responsabilité partagée) des retards non justifiés et problèmes qualité (3 cas — responsabilité du cabinet) ; formaliser cette analyse par écrit avec un plan de redressement exigé sous 15 jours ; activer la clause de performance pour les manquements documentés ; initier discrètement un plan de contingence (prestataire alternatif ou ressources internes de backup) ; informer le comité de pilotage du risque résiduel sur le délai réglementaire.`,
    `B. Accepter la position du cabinet pour éviter le conflit contractuel et absorber les retards dans vos réserves.`,
...
{ id:"PR-009", domaine:"Processus", approche:"Prédictif", type:"standard",
  ...
  options:[
    `A. Encourager et aider l'ingénieur à documenter formellement l'analyse technique révisée des fondations, mettre à jour officiellement le planning pour refléter la durée réaliste de 14 semaines, informer le comité de pilotage et le client du retard identifié avec une analyse des options de mitigation — un retard signalé tôt peut être géré ; découvert en retard il devient une crise.`,
    `B. Accepter la position de l'ingénieur de ne pas signaler officiellement — modifier le planning officiellement à ce stade créerait une alarme prématurée chez le client.`,
...
{ id:"PR-010", domaine:"Processus", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Passer entièrement à Kanban sans sprints pour s'adapter à la nature réactive du travail avec les clients.`,
    `C. Imposer une règle stricte de protection des sprints sans aucune exception — la discipline Agile est nécessaire pour retrouver la productivité.`
    `D. Reconnaître que le modèle Scrum avec des sprints fixes n'est pas adapté à ce flux de travail réactif ; travailler avec le PO sur une solution hybride : définir un "fast lane" (20 % de la capacité de sprint réservé aux urgences client sans engagement de sprint) et un "planned lane" (80 % pour les fonctionnalités planifiées) ; établir des critères clairs pour ce qui constitue une "vraie urgence" vs une "fonctionnalité souhaitée urgent", et améliorer la communication des engagements de sprint avec les clients pour réduire les attentes irréalistes de réactivité immédiate.`,,
  ],
  correct:3,
...
{ id:"PR-014", domaine:"Processus", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Éliminer les dépendances en redécoupant l'architecture pour rendre chaque équipe entièrement autonome.`,
    `C. Centraliser la gestion de toutes les dépendances auprès du Release Train Engineer qui sera le point de coordination unique entre toutes les équipes.`
    `D. Faciliter une session dédiée de résolution des dépendances (Dependency Resolution Workshop) lors du PI Planning : visualiser toutes les dépendances sur le Program Board avec des fils de couleur, identifier les 5-8 dépendances les plus critiques (sur le chemin critique du programme), faciliter des négociations bilatérales entre les équipes concernées pour définir les interfaces et les dates de livraison, et attribuer un "dependency owner" pour chaque dépendance critique — en documentant les engagements dans le PI Plan.`,,
  ],
  correct:3,
...
{ id:"PR-015", domaine:"Processus", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Consulter un avocat spécialisé en droit du patrimoine pour confirmer l'obligation avant d'agir — vous voulez être sûr avant de bloquer les travaux.`,
    `C. Documenter la découverte par photos et continuer les travaux — si le maître d'ouvrage assume la responsabilité légale par écrit, vous êtes couvert.`
    `D. Arrêter immédiatement les travaux dans la zone concernée, effectuer la déclaration obligatoire aux autorités patrimoniales dans les délais légaux, informer le maître d'ouvrage par écrit de l'obligation légale et des conséquences du non-respect (responsabilité pénale pour destruction de patrimoine culturel), analyser les options d'adaptation du planning (poursuite des travaux dans d'autres zones pendant l'évaluation patrimoniale) et mettre à jour le registre des risques avec ce nouvel événement.`,
  ],
  correct:3,
...
{ id:"PR-017", domaine:"Processus", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Souscrire uniquement si le programme ne dispose pas d'une réserve pour aléas suffisante pour absorber le risque.`,
    `C. Analyser par la VME : VME du risque = 0,40 × 450 000 € = 180 000 €. La prime d'assurance de 85 000 € est inférieure à la VME de 180 000 € — l'assurance est financièrement justifiée. De plus, l'assurance transforme un risque variable (0 à 450 000 €) en un coût certain (85 000 €) permettant une meilleure maîtrise budgétaire — recommander la souscription au comité de pilotage.`,
...
{ id:"PR-018", domaine:"Processus", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Demander au développeur de corriger la faille pendant ses heures personnelles pour ne pas affecter la vélocité du sprint.`,
    `C. Créer une user story "corriger l'injection SQL" dans le backlog et la prioriser dans le prochain sprint planning.`
    `D. Encourager le développeur à signaler immédiatement la faille (c'est la bonne décision) ; évaluer la sévérité de la faille avec l'équipe de sécurité ; si la faille est critique (accès potentiel aux données clients), la corriger immédiatement dans le sprint courant comme priorité de sécurité — la vélocité du sprint est secondaire face à un risque de sécurité ; documenter la correction comme un bug de sécurité et non une story standard ; mettre à jour le processus de revue de sécurité pour détecter ce type de faille plus tôt dans le cycle.`,
  ],
  correct:3,
...
{ id:"PR-020", domaine:"Processus", approche:"Hybride", type:"standard",
  ...
  options:[
    ...
    `B. Déployer dans les 2 autres pays uniquement dans les zones urbaines avec bonne connectivité et exclure les zones rurales du premier déploiement.`,
    `C. Demander à l'opérateur réseau de garantir une meilleure couverture dans les zones rurales avant le déploiement — le problème est une infrastructure réseau insuffisante, pas l'application.`
...
{ id:"PR-024", domaine:"Processus", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Accepter de baisser temporairement la couverture mais insister sur la revue de code immédiate.`,
    `C. Appeler le Scrum Master immédiatement pour qu'il arbitre — aucune décision ne peut être prise sur la DoD en son absence.`
    `D. Refuser de baisser la DoD en dehors du processus formel ; si la story ne peut pas être complétée selon la DoD dans ce sprint, elle ne sera pas considérée comme "Done" et passera au sprint suivant — la DoD est un engagement collectif de l'équipe et ne peut être modifiée unilatéralement par un développeur et le PO en l'absence du Scrum Master ; si l'équipe considère que la DoD est trop exigeante, elle devra être révisée lors d'une rétrospective avec l'ensemble de l'équipe.`,,
  ],
  correct:3,
...
{ id:"PR-027", domaine:"Processus", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Faire payer l'intégralité des 95 000 € au bureau d'études — l'erreur est dans les plans qu'il a produits.`,
    `C. Payer les 95 000 € sur le budget projet sans chercher de responsabilité — les arbitrages entre parties prenantes risquent de retarder la correction et compromettre le planning.`
    `D. Reconnaître que la responsabilité est partagée (erreur de plans du bureau d'études + non-vérification des normes applicables par le CVC) ; engager une discussion constructive entre les trois parties (maître d'ouvrage, bureau d'études, CVC) pour partager équitablement le coût de correction selon la responsabilité respective ; procéder immédiatement à la correction pour ne pas bloquer le projet en attente de l'arbitrage financier — et finaliser l'accord de répartition en parallèle.`,
  ],
  correct:3,
...
{ id:"PR-028", domaine:"Processus", approche:"Agile", type:"standard",
  ...
  options:[
    `A. Évaluer si la valeur apportée par le refinement justifie le temps investi : si la qualité des stories s'est améliorée (moins de reprises, moins de carry-overs), le ROI peut être positif même à 25 % de temps de réunion. Cependant, explorer des optimisations : refinement asynchrone pour la partie documentaire (les membres préparent leurs questions avant la réunion), réduction de la durée de la mêlée si elle est redondante avec le refinement, et vérifier si 1h/semaine est nécessaire ou si 45 min tous les 10 jours serait suffisant — l'objectif n'est pas de minimiser les réunions mais d'optimiser le ratio valeur/coût.`,
    `B. Accepter le ratio de 25 % de réunions — les cérémonies Agile sont nécessaires et ce niveau est dans la norme.`,
...
{ id:"PR-029", domaine:"Processus", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Rebasaligner uniquement le planning (pas le budget) pour améliorer l'IPC-Cal tout en gardant l'IPC-C visible.`,
    `C. Inclure le rebasalinement dans le rapport en le présentant comme une "mise à jour de référence de management" — une pratique courante dans les programmes de grande envergure.`
    `D. Refuser le rebasalinement non autorisé : il s'agirait d'une manipulation des données de performance qui tromperait le bailleur de fonds sur la situation réelle du programme. Si une révision du planning de référence est justifiée (périmètre modifié, changements approuvés), elle doit passer par un processus de maîtrise intégrée des modifications avec approbation formelle du bailleur. Le rapport trimestriel doit présenter honnêtement les données EVM actuelles avec une analyse causale des écarts et un plan d'action correctif crédible.`,
  ],
  correct:3,
...
{ id:"PR-030", domaine:"Processus", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Désigner un architecte solution dédié qui devra valider toutes les décisions techniques avant implémentation — supprimer l'autonomie architecturale de l'équipe.`,
    `C. Accepter les deux approches et laisser l'équipe gérer la divergence progressivement au fil des sprints — la cohérence architecturale se consolidera naturellement.`
    `D. Pour l'incident immédiat : faire décider à l'équipe (pas uniquement au tech lead) laquelle des deux approches est la meilleure pour le long terme, allouer 3 jours pour la refactorisation, et traiter cela comme un coût d'apprentissage documenté dans la rétrospective. Pour l'avenir : introduire une pratique d'Architecture Decision Records (ADR) — documents courts décrivant les décisions architecturales importantes, leur contexte et leurs implications — partagés dans le repository de code et discutés brièvement en équipe avant implémentation ; des pratiques de mob programming pour les décisions architecturales complexes.`,
  ],
  correct:3,
...
{ id:"EA-004", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Commencer la mise en conformité uniquement quand les premiers avertissements réglementaires seront émis — les régulateurs accordent généralement des délais de grâce aux startups.`,
    `C. Vendre la startup avant l'échéance de conformité pour éviter d'investir dans une refonte non rentable.`
    `D. Expliquer au CA que la mise en conformité EHDS n'est pas optionnelle — c'est une obligation légale avec des sanctions significatives (amendes, interdiction de traiter des données de santé). Recommander d'initier immédiatement la planification de la mise en conformité (18 mois, c'est exactement le délai nécessaire pour une refonte architecturale de 8 mois avec marge) ; explorer les options de financement (subventions publiques numérique/santé, intégration dans les fonctionnalités vendables comme avantage concurrentiel) ; les données de santé conformes EHDS deviendront un avantage différenciateur sur le marché.`,
  ],
  correct:3,
...
{ id:"EA-006", domaine:"Environnement d'affaires", approche:"Hybride", type:"standard",
  ...
  options:[
    ...
    `B. Démarrer sur une base informelle mais documenter soigneusement toutes les réunions et échanges pour se protéger en cas de litige.`,
    `C. Démarrer uniquement les activités préliminaires non facturables (réunion de kick-off, collecte d'informations) en attendant la signature du contrat.`
    `D. Ne pas démarrer le projet sans contrat signé ; expliquer au client et à votre direction les risques concrets : absence de définition formelle du périmètre (risque de désaccord sur les livrables), absence de clause de paiement (risque de non-paiement en cas de litige ou de changement de direction chez le client), absence de clause de confidentialité formelle (risque légal sur les informations échangées) ; proposer au client de signer un "accord de démarrage" simplifié (1-2 pages) définissant le périmètre, les livrables initiaux et les conditions de paiement — cela peut être fait en 24-48 heures sans ralentir significativement le démarrage.`,,
  ],
  correct:3,
...
{ id:"EA-007", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Remplacer la vélocité en story points par des indicateurs OKR pour mesurer la performance de l'équipe.`,
    `C. Traiter les OKR comme des contraintes organisationnelles et continuer à travailler le backlog tel qu'il est — les OKR sont un cadre de direction générale qui ne change pas le travail quotidien de l'équipe.`
    `D. Faciliter une session de mapping OKR-to-backlog avec le Product Owner et l'équipe : identifier quelles fonctionnalités ou améliorations du produit pourraient impacter chaque KR ; créer des hypothèses testables (si nous développons X, nous prévoyons une amélioration de Y sur le KR Z) ; prioriser les stories du backlog selon leur impact estimé sur les KRs ; définir des métriques de mesure pour chaque sprint (est-ce que les fonctionnalités livrées ont l'impact attendu ?) — les OKR guident la priorisation du backlog, pas sa formulation.`,
  ],
  correct:3,
...
{ id:"EA-013", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Recommander d'attendre que la migration cloud soit à 100 % avant d'initier le projet CI/CD — l'infrastructure est le prérequis fondamental.`,
    `C. Recommander une feuille de route de 12-18 mois vers le CI/CD en 3 phases : Phase 1 (0-6 mois) — atteindre >80 % de couverture de tests automatisés (indispensable pour CI/CD sécurisé), finaliser la migration cloud, rendre les revues de code obligatoires dans la Définition de Fini. Phase 2 (6-12 mois) — automatiser le pipeline de déploiement avec des gates qualité automatiques, réduire les approbations de 4 à 2 (validation automatique + approbation humaine unique). Phase 3 (12-18 mois) — déploiement continu avec rollback automatique et monitoring avancé — avec métriques de succès définies pour chaque phase.`,
...
{ id:"EA-014", domaine:"Environnement d'affaires", approche:"Prédictif", type:"standard",
  ...
  options:[
    `A. Reporter le déploiement jusqu'à la correction complète et testée du bug, quel que soit l'impact sur la communication publique du DG ; préparer immédiatement avec le DG et l'équipe de communication une annonce honnête expliquant que le report est lié à la découverte d'un bug de qualité critique lors des tests — les parties prenantes comprendront mieux un report proactif qu'une correction d'urgence post-déploiement de duplications d'écritures comptables.`,
    `B. Déployer selon le calendrier prévu mais bloquer temporairement les 3 modules concernés jusqu'à la correction du bug — les autres fonctionnalités peuvent être mises en service.`,
...
{ id:"IA-002", domaine:"IA & Durabilité", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Lancer avec un disclaimer indiquant que les recommandations sont "à titre informatif uniquement" — cela protège la banque légalement.`,,
    `C. Demander à l'équipe de data science de documenter le biais dans le rapport technique mais pas dans la documentation produit visible.`
    `D. Bloquer le lancement et expliquer que ce comportement viole simultanément : les obligations fiduciaires du conseiller financier (devoir de conseil dans l'intérêt du client), les directives réglementaires sur la commercialisation des produits financiers (MiFID II équivalent), et les principes d'IA responsable (ECO PMP® 2026). Initier une correction de l'algorithme pour aligner les recommandations sur le profil réel du client indépendamment des revenus. Soumettre la situation à la conformité et à l'éthique de la banque.`,
  ],
  correct:3,
...
{ id:"IA-003", domaine:"IA & Durabilité", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Faire appel à un audit externe du fournisseur pour corriger le biais — la responsabilité de correction incombe au fournisseur.`,
    `C. Rejeter ce mode d'allocation et expliquer que l'algorithme encode et perpétue les inégalités historiques d'opportunités — si des profils n'ont pas eu accès aux projets à forte visibilité historiquement, leurs données de performance sur ces projets sont absentes. L'IA n'évalue pas leur capacité mais leur historique d'opportunités. Mettre en place une allocation mixte : recommandations IA comme input parmi d'autres facteurs (potentiel évalué, développement de carrière, diversité) avec décision humaine finale et traçabilité des critères.`,
...
{ id:"IA-004", domaine:"IA & Durabilité", approche:"Hybride", type:"standard",
  ...
  options:[
    `A. Présenter une analyse multicritères complète : scénario L1+L2 (surcoût 1,1 M€, résultat 630 kgCO₂e/m² — sous l'objectif) ; scénario L1+L3 (surcoût 730 k€, résultat 680 — au-dessus) ; scénario L1+L2+L3 (surcoût 1,41 M€, résultat 595, VAN sur 20 ans positive après revenus PV). Présenter les trois scénarios avec impact financier, carbone et business case du client pour une décision éclairée.`,
    `B. Recommander uniquement L1 (béton bas carbone) car c'est le meilleur ratio réduction/surcoût — mais 810-95 = 715 kgCO₂e/m², encore au-dessus de l'objectif.`,
...
{ id:"IA-005", domaine:"IA & Durabilité", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Proposer une option de "mode neutre" où les candidats peuvent masquer leur nom dans les recommandations — solution technique contournant le biais sans modifier l'algorithme.`,,
    `C. Documenter le biais dans le backlog produit comme story à traiter dans les prochains sprints selon les priorités du PO.`
    `D. Expliquer au PO que l'algorithme amplifie une discrimination illégale dans la plupart des pays (discrimination à l'embauche basée sur l'origine). Engager : (1) suspension ou déclassement de l'algorithme biaisé ; (2) correction en retirant les variables proxy discriminatoires ; (3) notification à l'équipe juridique et conformité ; (4) communication transparente si des candidats ont été lésés ; (5) monitoring anti-discrimination dans le pipeline MLOps.`,
  ],
  correct:3,
...
{ id:"IA-008", domaine:"IA & Durabilité", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Augmenter l'équipe d'agents humains pour absorber les 33 % de cas non résolus.`,
    `C. Communiquer en début de conversation que "le chatbot peut faire des erreurs et que ses réponses doivent être vérifiées" — une clause de responsabilité appropriée.`
    `D. Traiter en priorité les réponses incorrectes confiantes (groupe 1) : auditer les 18 % de cas problématiques pour identifier les domaines où l'IA est systématiquement incorrecte mais confiante ; corriger les bases de connaissance ou désactiver l'autonomie du chatbot pour ces catégories ; contacter proactivement les clients impactés pour corriger les actions erronées ; mettre en place un indicateur de calibration de la confiance (le niveau de certitude exprimé correspond-il à la précision réelle ?) dans le monitoring continu.`,
  ],
  correct:3,
...
{ id:"IA-012", domaine:"IA & Durabilité", approche:"Hybride", type:"standard",
  ...
  options:[
    ...
    `B. Reporter la publication de 3 mois pour permettre de corriger les données sur l'empreinte carbone cycle de vie (contacter le fournisseur pour obtenir des données plus favorables).`,
    `C. Publier le rapport avec les données réelles mais ajouter une note de bas de page indiquant que "les méthodes de calcul de l'empreinte carbone cycle de vie varient selon les sources".`
    `D. Rédiger un rapport complet et transparent : tous les indicateurs avec réalisations vs objectifs (positifs et négatifs) ; analyse causale des écarts (infrastructure de charge insuffisante, trajets ruraux non anticipés, mix énergétique batteries non intégré) ; plan d'action correctif concret pour les 18 mois restants ; note méthodologique reconnaissant la lacune de l'analyse initiale sur l'empreinte cycle de vie — ce rapport servira à améliorer les pratiques de reporting ESG futures.`,
  ],
  correct:3,
...
{ id:"IA-014", domaine:"IA & Durabilité", approche:"Prédictif", type:"standard",
  ...
  options:[
    `A. Traiter comme une modification formelle du périmètre : (1) soumettre une demande de modification au CCM avec analyse d'impact (ressources, budget, délai nécessaires — estimation 45-65 k€ avec un cabinet spécialisé, 3-4 mois) ; (2) proposer une feuille de route de mise en compétence (court terme : sous-traiter à un cabinet spécialisé ; moyen terme : former 2 membres de l'équipe aux méthodologies carbone pour les programmes futurs) ; (3) voir dans cette demande une opportunité d'avancer sur la compétence durabilité de l'organisation.`,
    `B. Refuser poliment — la demande n'est pas dans le périmètre contractuel initial et ajouter un bilan carbone sans budget ni ressources est irréaliste.`,
...
{ id:"IA-015", domaine:"IA & Durabilité", approche:"Hybride", type:"standard",
  ...
  options:[
    `A. Expliquer que même si la corrélation géographique avec la fraude est statistiquement réelle, un taux de faux positifs 4x supérieur pour des populations déjà financièrement vulnérables constitue un impact disproportionné discriminatoire (les réglementations bancaires imposent une équité de traitement dans l'accès aux services financiers). Lancer une analyse de performance différenciée et explorer des techniques de fair ML (contraintes d'équité sur les faux positifs par groupe) pour réduire le différentiel de traitement sans dégrader significativement la détection de fraude réelle.`,
    `B. Accepter la position de la direction — si le taux de fraude est effectivement plus élevé dans ces zones, la précision différentielle est statistiquement justifiée.`,
...
{ id:"IA-017", domaine:"IA & Durabilité", approche:"Prédictif", type:"standard",
  ...
  options:[
    `A. Intégrer par un processus formel : (1) soumettre une demande de modification au CCM documentant l'impact complet (123 000 € de surcoût estimé, 6 semaines additionnelles, 0,5 ETP) ; (2) négocier avec l'entreprise générale le claim de 95 000 € en demandant une décomposition détaillée — certains coûts peuvent être optimisés ; (3) évaluer si des économies compensatrices existent ailleurs dans le projet ; (4) proposer à l'hôpital un amendement contractuel intégrant formellement l'objectif zéro décharge comme exigence qualité avec ses impacts documentés.`,
    `B. Refuser l'objectif "zéro décharge" car non prévu dans les spécifications initiales et générant un surcoût (95 k€ + 28 k€) non prévu.`,,
...
{ id:"IA-019", domaine:"IA & Durabilité", approche:"Hybride", type:"standard",
  ...
  options:[
    ...
    `B. Choisir le Fournisseur C car sa technologie adiabatique réduit de 40 % la consommation d'eau — c'est l'option la plus alignée avec les objectifs ESG à long terme.`,
    `C. Négocier avec le Fournisseur A pour qu'il adopte une politique ESG minimale avant signature — bénéficier de l'économie budgétaire tout en respectant l'esprit de la politique ESG.`
    `D. Conduire une analyse multicritères formelle intégrant les dimensions financière, technique, calendaire et ESG conformément à la politique d'achats durables : documenter les critères et pondérations avant l'évaluation (ex : coût 35 %, technique 25 %, délai 15 %, ESG 25 %), appliquer la grille à chaque fournisseur, présenter l'analyse et la recommandation au CCM — vraisemblablement B ou D selon les pondérations, avec note sur C (innovant mais risqué) et exclusion motivée de A (non-conformité politique ESG).`,
  ],
  correct:3,
...
{ id:"IA-029", domaine:"IA & Durabilité", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Corriger l'architecture discrètement en réallouant des budgets existants — l'amélioration sera visible dans les rapports de performance sans créer de bruit politique autour d'une erreur initiale.`,
    `C. Présenter une analyse complète et honnête au comité de pilotage : (1) état actuel documenté vs benchmarks (surcoût énergétique de 34 %) ; (2) analyse coût-bénéfice de la correction (investissement 8,2 M€ vs économies 12,4 M€ + bénéfices environnementaux sur 13 ans) ; (3) plan de migration avec jalons et risques ; (4) alternative de non-correction avec ses coûts sur la durée d'exploitation. La responsabilité de transparence envers le comité inclut de signaler les opportunités d'amélioration identifiées en cours de programme, même quand elles remettent en question des décisions passées.`,
...
{ id:"P-031", domaine:"Personnes", approche:"Agile", type:"standard",
  ...
  options:[
    `A. Explorer avec eux les raisons de ce désengagement (format inadapté ? sentiment que leur avis n'est pas pris en compte ? préférence pour la communication écrite ?) ; tester des adaptations du format (réunions plus courtes, contribution asynchrone préalable, rôles tournants d'animateur) pour voir ce qui augmente leur engagement réel.`,
    `B. Rendre la participation aux réunions obligatoire et noter les absences — la discipline collective est non négociable dans une équipe Agile.`,
...
{ id:"P-034", domaine:"Personnes", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Prendre vous-même les décisions de priorisation en l'absence du PO — quelqu'un doit décider.`,
    `C. Réduire la fréquence des sprints à mensuelle pour s'adapter au rythme de disponibilité du PO.`,
    `D. Documenter l'impact concret de l'indisponibilité du PO (taux de reprise, vélocité réduite, stories non livrables) et présenter cette analyse au sponsor ou au management du PO pour obtenir soit une augmentation de la disponibilité du PO, soit la désignation d'un PO délégué ou d'un proxy PO pour les décisions quotidiennes — un PO indisponible est un risque projet critique, pas une contrainte à absorber passivement.`,
  ],
  correct:3,
...
{ id:"P-039", domaine:"Personnes", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Ignorer les demandes du manager en espérant qu'il comprendra avec le temps le fonctionnement Agile.`,
...
{ id:"P-044", domaine:"Personnes", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Lancer les tests de confirmation en urgence et n'informer Airbus que si la non-conformité est confirmée — éviter les fausses alarmes préserve la relation commerciale.`,
    `C. Consulter d'abord votre service juridique pour évaluer les responsabilités avant d'informer Airbus — une communication prématurée pourrait être utilisée contre vous en cas de litige.`,
    `D. Informer immédiatement Airbus de la situation telle qu'elle est : des données préliminaires indiquent une possible non-conformité sur le paramètre X avec une probabilité estimée de 40 % ; des tests de confirmation sont en cours (délai : X jours) ; des mesures conservatoires sont envisageables (blocage de l'utilisation des pièces concernées jusqu'à confirmation) — la décision de l'action conservatoire appartient à Airbus. Dans l'aéronautique, informer tardivement d'une non-conformité potentielle sur des pièces en service est une faute grave.`,
  ],
  correct:3,
...
{ id:"P-047", domaine:"Personnes", approche:"Hybride", type:"standard",
  ...
  options:[
    ...
    `B. Développer la fonctionnalité avec un accès réservé au DRH uniquement — limiter l'accès réduit le risque.`,
    `C. Soumettre la demande au comité de direction pour validation — une décision aussi sensible doit être approuvée au plus haut niveau.`,
    `D. Expliquer au DRH que cette fonctionnalité soulève des problèmes légaux sérieux (le RGPD et les droits du travail dans la plupart des pays encadrent strictement la surveillance des communications des employés, même sur les outils de l'entreprise, et exigent consultation des représentants du personnel et base légale explicite) et des risques majeurs de confiance organisationnelle ; recommander de consulter le DPO et le service juridique avant toute décision, et proposer des alternatives légales pour détecter les problèmes d'ambiance (enquêtes anonymes, entretiens managériaux structurés, indicateurs RH de bien-être).`,
  ],
  correct:3,
...
{ id:"PR-038", domaine:"Processus", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Intégrer la refactorisation progressivement (20 % de chaque sprint) sans en informer le PO — la qualité technique est une responsabilité de l'équipe, pas du PO.`,
    `C. Présenter l'opportunité au Product Owner avec une analyse coût-bénéfice claire : 3 sprints de refactorisation maintenant vs performances/scalabilité insuffisantes dans 12-18 mois quand la charge utilisateur augmentera. Laisser le PO décider en connaissance de cause — si approuvé, créer des stories d'architecture formelles dans le backlog et les prioriser selon la décision du PO. Si refusé, documenter la décision et les risques techniques acceptés.`,
...
{ id:"PR-039", domaine:"Processus", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Demander à l'autorité portuaire (votre client) de gérer la relation syndicale — c'est une question de relations sociales qui dépasse les attributions du chef de projet.`,
    `C. Accélérer le déploiement avant que l'opposition syndicale ne s'organise davantage — un fait accompli est plus facile à gérer que de long débats.`,
    `D. Identifier le syndicat comme partie prenante à haute influence/haute résistance dans votre registre des parties prenantes ; solliciter une réunion avec les représentants syndicaux pour comprendre leurs préoccupations précises (quels emplois ? quelles modifications de postes ?) ; présenter les données réelles sur l'impact du système sur l'emploi (si aucune suppression de poste n'est prévue, le dire clairement ; si des modifications de postes sont prévues, être honnête sur leur nature) ; proposer de les impliquer dans la définition des formations et du plan d'accompagnement.`,
  ],
  correct:3,
...
{ id:"EA-020", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  ...
  options:[
    ...
    `B. Lancer la plateforme dans 3 mois car les 4 mois réglementaires courent à compter de la publication de la circulaire, pas du lancement de la plateforme.`,
    `C. Analyser précisément les exigences KYC de la circulaire et leur impact sur l'architecture de la plateforme ; évaluer si la conformité peut être atteinte en 3 mois (avant le lancement) — si oui, intégrer immédiatement les requirements KYC dans le backlog prioritaire ; si non, présenter au client les deux options : (1) report du lancement de 4-6 semaines pour être conforme dès le lancement, (2) lancement dans 3 mois avec les fonctionnalités KYC existantes et mise à niveau dans les 4 mois réglementaires. Consulter le service juridique et le régulateur pour confirmer si un lancement non entièrement conforme avec plan de mise en conformité est acceptable.`,
...
{ id:"EA-022", domaine:"Environnement d'affaires", approche:"Hybrid", type:"standard",
  ...
  options:[
    ...
    `B. Continuer le déploiement comme prévu — la fusion peut ne pas se réaliser et le concurrent peut ne pas modifier les conditions de la solution.`,
    `C. Proposer immédiatement une migration vers une solution alternative avant la fusion — mieux vaut prévenir.`,
    `D. Alerter immédiatement le client de ce risque stratégique ; analyser les options disponibles : (1) négocier maintenant avec le fournisseur (avant la fusion) des clauses contractuelles protectrices (droits source code en escrow, garanties de continuité de service, clauses de résiliation sans pénalité) ; (2) évaluer les solutions alternatives qui pourraient remplacer le composant central (coût de migration, délai, risque de transition) ; (3) accélérer la finalisation du déploiement pour minimiser la dépendance future ; (4) consulter le service juridique sur les options contractuelles. La décision stratégique appartient au client mais il doit être informé immédiatement.`,
  ],
  correct:3,
...
{ id:"EA-023", domaine:"Environnement d'affaires", approche:"Prédictif", type:"standard",
  ...
  options:[
    ...
    `B. Mandater un expert en communication de crise pour gérer la relation avec l'ONG et négocier que l'étude ne soit pas publiée.`,
    `C. Prendre la situation au sérieux immédiatement : commander une contre-expertise indépendante pour évaluer l'étendue réelle des dommages ; informer le maître d'ouvrage et le service juridique ; contacter les autorités environnementales compétentes de manière proactive avant que l'étude soit publiée (la proactivité est valorisée par les régulateurs et les tribunaux) ; arrêter tout travail offshore susceptible d'aggraver les dommages ; évaluer les options de remédiation (restauration du récif).`,
...
,
// ── Questions extra complétant la banque à 180+ ──
// ── PROCESSUS supplémentaires ───────────────────────────────────

{ id:"PR-051", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Dans un projet de construction d'une usine pharmaceutique (55 M€, 40 mois), votre analyse EVM au mois 20 donne : VP = 27,5 M€, VA = 23,375 M€, CR = 26,125 M€. Quelle est la Valeur à l'Achèvement (EAC) et que recommandez-vous ?`,
  options:[
    `A. EAC = 55 M€ — le projet est dans les limites budgétaires et ne nécessite pas d'action corrective.`,
    `B. EAC = BAC/IPC-C = 55/0,895 = 61,45 M€. Le projet présente un retard (IPC-Cal = 0,85) et un surcoût (IPC-C = 0,895). Recommander une revue immédiate des causes de dérive et un plan correctif ciblé sur les activités les plus consommatrices.`,
    `C. EAC = CR + (BAC - VA) = 26,125 + 31,625 = 57,75 M€ en supposant que les travaux restants seront réalisés au budget — cette hypothèse optimiste est appropriée si les causes du dépassement actuel sont ponctuelles.`,
    `D. EAC ne peut pas être calculée sans connaître les raisons du dépassement — il faut d'abord comprendre les causes avant de projeter l'achèvement.`,
  ],
  correct:2,
  explication:`La réponse C est correcte dans le cas où les dépassements sont ponctuels et non systémiques. IPC-Cal = 23,375/27,5 = 0,85 ; IPC-C = 23,375/26,125 = 0,895. L'EAC optimiste = CR + (BAC-VA) = 57,75 M€ suppose que les coûts restants suivront le plan. L'EAC pessimiste (B) = BAC/IPC-C = 61,45 M€ suppose que la tendance actuelle se maintiendra. Le choix entre les deux dépend de l'analyse des causes. La réponse A est fausse car IPC-C < 1 indique déjà un dépassement en cours.`,
},

{ id:"PR-052", domaine:"Processus", approche:"Agile", type:"standard",
  question:`Votre équipe Agile termine le sprint 6. La vélocité des 6 derniers sprints est : 38, 41, 39, 43, 40, 42. Le backlog restant est de 320 story points. Quelle est la meilleure estimation de la date de livraison et comment la présentez-vous au client ?`,
  options:[
    `A. 320 / 38 = 8,4 sprints — présenter 9 sprints (arrondi supérieur) comme engagement ferme.`,
    `B. Calculer la moyenne (40,5 pts) et l'écart-type (σ ≈ 1,7 pts). Fourchette : 320/42,2 = 7,6 à 320/38,8 = 8,2 sprints. Présenter au client une fenêtre de livraison entre 8 et 9 sprints avec une prévision centrale à 8 sprints — en précisant que cette fourchette est basée sur la vélocité historique et peut évoluer.`,
    `C. 320 / 40,5 = 7,9 sprints — s'engager sur 8 sprints car la vélocité est très stable.`,
    `D. Refuser de donner une date de livraison en Agile — les prévisions sont incompatibles avec le principe d'adaptation continue.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. La vélocité stable (38-43, σ ≈ 1,7) permet une prévision fiable mais doit être présentée avec une fourchette honnête (8 à 9 sprints) plutôt qu'une date unique fausse précision. L'écart-type faible justifie une fourchette étroite. Refuser de prévoir (D) est non professionnel. S'engager sur une date unique (A, C) sans fourchette donne une fausse impression de certitude.`,
},

{ id:"PR-053", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Dans un projet de développement logiciel (12 M€, 24 mois), votre registre des risques identifie 5 risques critiques. Le risque R1 a une probabilité de 30 % et un impact de 800 000 €. R2 a une probabilité de 60 % et un impact de 200 000 €. Quelle est la VME totale de ces deux risques et quel risque devez-vous traiter en priorité ?`,
  options:[
    `A. VME totale = 360 000 €. Priorité à R1 car son impact potentiel (800 000 €) est plus élevé.`,
    `B. VME R1 = 240 000 €, VME R2 = 120 000 €, VME totale = 360 000 €. Prioriser R1 car sa VME (240 000 €) est deux fois supérieure à R2 (120 000 €), même si R2 a une probabilité plus élevée.`,
    `C. VME R1 = 240 000 €, VME R2 = 120 000 €. Prioriser R2 car sa probabilité de 60 % en fait un risque quasi-certain qui doit être traité avant les risques moins probables.`,
    `D. VME R1 = 300 000 €, VME R2 = 60 000 €, VME totale = 360 000 €. La probabilité multipliée par l'impact réduit donne la priorité à R1.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. VME R1 = 0,30 × 800 000 = 240 000 €. VME R2 = 0,60 × 200 000 = 120 000 €. La VME est le critère standard de priorisation des risques en management de projet — elle intègre à la fois la probabilité et l'impact. R1 a une VME deux fois supérieure à R2 malgré sa probabilité plus faible. L'option A commet une erreur de calcul de la VME totale mais arrive au bon résultat par hasard. L'option D calcule incorrectement la VME.`,
},

{ id:"PR-054", domaine:"Processus", approche:"Hybride", type:"standard",
  question:`Vous gérez un projet de déploiement ERP hybride. Lors d'une réunion de revue mensuelle, votre client vous demande d'ajouter une fonctionnalité de reporting avancé non prévue dans le contrat — estimée à 3 sprints de travail. Il dit : "C'est urgent, nos actionnaires en ont besoin dans 6 semaines". Comment répondez-vous ?`,
  options:[
    `A. Démarrer immédiatement le développement de la fonctionnalité — la demande urgente d'un client est prioritaire sur les processus formels.`,
    `B. Analyser l'impact de la demande sur le périmètre, le calendrier et le budget actuels ; soumettre une demande de modification formelle au CCM avec l'analyse d'impact (3 sprints = délai de 6 semaines au minimum si démarrage immédiat, coût additionnel) ; explorer avec le client si certaines fonctionnalités planifiées peuvent être déprioritisées pour libérer la capacité nécessaire dans les 6 semaines.`,
    `C. Expliquer au client que la procédure de changement prend 4 semaines et qu'il est trop tard pour livrer dans les 6 semaines demandées.`,
    `D. Développer la fonctionnalité sur le temps libre de l'équipe sans impacter le budget ou le planning officiel.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Toute demande hors périmètre doit passer par le processus formel de contrôle des modifications (ECO T10) — mais le processus peut être accéléré dans les cas urgents. L'analyse d'impact est indispensable avant tout engagement. Explorer la déprioritisation de fonctionnalités existantes est une approche créative qui peut satisfaire l'urgence sans dérégler le projet. Démarrer sans processus (A) est une faute de gouvernance. Développer sur le temps libre (D) constitue un travail non déclaré et non facturé.`,
},

{ id:"PR-055", domaine:"Processus", approche:"Agile", type:"standard",
  question:`Vous êtes chef de projet d'une équipe qui développe une API REST. Lors d'une revue de code, un développeur senior identifie que l'architecture actuelle ne supportera pas une charge de 10 000 requêtes/seconde — contrainte non spécifiée initialement mais que vous savez que le client aura besoin dans 18 mois. Le Product Owner n'est pas au courant de cette contrainte future. Que faites-vous ?`,
  options:[
    `A. Continuer avec l'architecture actuelle — la contrainte de 10 000 req/s n'est pas dans les spécifications actuelles, l'équipe ne doit pas anticiper des besoins non formulés.`,
    `B. Corriger immédiatement l'architecture pour supporter 10 000 req/s même si ce n'est pas demandé — mieux vaut prévenir que guérir.`,
    `C. Informer le Product Owner de la contrainte future identifiée par l'équipe technique, lui présenter le coût de la correction maintenant (faible, architecture en cours) vs plus tard (élevé, refactorisation massive), et lui laisser décider en connaissance de cause. Créer une story technique "Architecture scalable 10k req/s" dans le backlog pour évaluation.`,
    `D. Documenter la contrainte dans le registre des risques et attendre que le client la soulève officiellement avant d'agir.`,
  ],
  correct:2,
  explication:`La réponse C est correcte. L'équipe a identifié un risque technique important avec un coût de correction croissant dans le temps — c'est une information précieuse à remonter au PO. La décision d'agir (et quand) appartient au PO, éclairé par l'expertise technique. Ignorer (A) ou attendre (D) peut conduire à une refactorisation coûteuse future. Corriger unilatéralement (B) sans consultation du PO prend une décision de périmètre qui ne revient pas à l'équipe seule.`,
},

{ id:"PR-056", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Dans un projet de construction d'un lycée (8,5 M€, 20 mois), votre entrepreneur principal sous-traite les travaux d'isolation thermique à une entreprise spécialisée. Lors de l'inspection finale, vous constatez que l'isolation ne respecte pas la résistance thermique R requise par la réglementation RE 2020. L'entrepreneur argue que le sous-traitant est seul responsable. Quelle est votre position ?`,
  options:[
    `A. Accepter la position de l'entrepreneur — le sous-traitant spécialisé est juridiquement responsable des travaux qu'il a réalisés.`,
    `B. Valider la livraison avec réserve et demander au sous-traitant de corriger directement.`,
    `C. Informer l'entrepreneur que dans un contrat de maîtrise d'œuvre globale, il est responsable de l'ensemble des travaux y compris ceux de ses sous-traitants ; exiger la correction de la non-conformité à ses frais, avec un délai défini ; documenter la non-conformité et son traitement. La sous-traitance ne décharge pas l'entrepreneur principal de sa responsabilité contractuelle vis-à-vis du maître d'ouvrage.`,
    `D. Accepter la livraison et initier une procédure de contentieux directement contre le sous-traitant au nom du maître d'ouvrage.`,
  ],
  correct:2,
  explication:`La réponse C est correcte. En droit de la construction, l'entrepreneur principal reste responsable vis-à-vis du maître d'ouvrage de l'ensemble des travaux, y compris ceux réalisés par ses sous-traitants. La non-conformité à RE 2020 est une non-conformité réglementaire grave. L'entrepreneur peut se retourner contre son sous-traitant, mais c'est sa relation interne — le maître d'ouvrage s'adresse à l'entrepreneur principal. Valider avec réserve (B) est insuffisant pour une non-conformité réglementaire. La procédure directe (D) n'est généralement pas possible car il n'y a pas de lien contractuel direct entre le maître d'ouvrage et le sous-traitant.`,
},

{ id:"PR-057", domaine:"Processus", approche:"Agile", type:"standard",
  question:`Votre équipe Scrum a adopté le "definition of ready" (DoR) pour les user stories. Lors du sprint planning du sprint 9, le PO présente une story qui ne respecte pas 2 des 5 critères du DoR (pas de maquette validée, critères d'acceptation incomplets). L'équipe est divisée : 3 membres veulent l'accepter quand même car "la story est urgente", 2 membres veulent maintenir le DoR. Quelle décision prenez-vous ?`,
  options:[
    `A. Accepter la story dans le sprint — l'urgence justifie une exception au DoR.`,
    `B. Refuser la story et demander au PO de compléter les critères manquants pour le prochain sprint — le DoR doit être respecté sans exception.`,
    `C. Organiser un vote de l'équipe — la décision collective est souveraine en Agile.`,
    `D. Vérifier si les 2 critères manquants peuvent être complétés dans les premières heures du sprint (par le PO ou un member de l'équipe) ; si oui, accepter la story conditionnellement avec une time-box de 4 heures pour finaliser les critères avant de démarrer le développement ; si non, refuser et travailler avec le PO à une story de remplacement prioritaire.`,
  ],
  correct:3,
  explication:`La réponse D est correcte. Elle est pragmatique et respectueuse à la fois du DoR et de l'urgence métier. La solution conditionnelle (compléter les critères en 4h) permet de satisfaire les deux impératifs. Le DoR n'est pas une règle bureaucratique mais un outil de qualité — son application intelligente peut inclure une complétion rapide au début du sprint. Le vote collectif (C) n'est pas approprié pour des décisions sur les processus d'équipe qui relèvent du Scrum Master. Le refus catégorique (B) sans alternative peut bloquer un besoin métier réel.`,
},

{ id:"PR-058", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Vous êtes chef de projet pour un programme de déploiement de 200 bornes de recharge VE (12 M€, 18 mois). Votre plan d'approvisionnement repose sur un seul fournisseur européen de bornes. À mois 8, votre fournisseur annonce qu'une cyber-attaque a paralysé ses systèmes de production pour une durée inconnue (estimée à 4-8 semaines). Comment gérez-vous cette crise d'approvisionnement ?`,
  options:[
    `A. Attendre la reprise de production du fournisseur — la cyber-attaque est un cas de force majeure qui sera couvert par les clauses contractuelles.`,
    `B. Contacter immédiatement 3-5 fournisseurs alternatifs pour évaluer la disponibilité de bornes compatibles et les délais de livraison ; évaluer si l'installation peut être réséquencée pour prioriser les sites avec bornes déjà livrées ; informer le client de la situation et des options ; activer les clauses de force majeure du contrat fournisseur pour documenter le préjudice ; ne pas attendre la fin de la cyber-attaque sans action de contingence.`,
    `C. Résilier le contrat fournisseur immédiatement et sélectionner un nouveau fournisseur principal via appel d'offres accéléré.`,
    `D. Demander une extension de délai au client en invoquant la force majeure — le retard du fournisseur vous décharge de votre responsabilité contractuelle.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Une cyber-attaque sur le fournisseur unique est exactement le risque de concentration d'approvisionnement qui aurait dû figurer dans le registre des risques. La réponse immédiate doit être multicanale : recherche de fournisseurs alternatifs, reséquencement des installations, information du client, activation des clauses contractuelles. Attendre passivement (A) laisse le planning se dégrader sans action. La résiliation immédiate (C) sans alternatives qualifiées crée un vide d'approvisionnement encore plus long. La demande d'extension seule (D) sans plan alternatif est insuffisante.`,
},

{ id:"PR-059", domaine:"Processus", approche:"Hybride", type:"standard",
  question:`Dans un programme de transformation en mode hybride, votre équipe Agile a livré 8 sprints de fonctionnalités. Le responsable de la sécurité informatique vous informe que lors d'un audit, il a identifié que les fonctionnalités des sprints 3 à 6 n'ont jamais subi de tests de sécurité (OWASP). Il estime qu'entre 15 et 40 % des fonctionnalités pourraient présenter des vulnérabilités. Comment gérez-vous cette situation ?`,
  options:[
    `A. Planifier les tests de sécurité après la livraison finale — les tests de sécurité en cours de projet ralentissent les sprints.`,
    `B. Suspendre les nouvelles fonctionnalités et auditer immédiatement les sprints 3-6, puis corriger toutes les vulnérabilités avant de continuer.`,
    `C. Intégrer immédiatement les tests de sécurité dans la Définition de Fini pour tous les sprints futurs ; planifier un sprint de sécurité dédié pour auditer les fonctionnalités des sprints 3-6 (prioriser par criticité des données traitées) ; présenter au client le risque identifié et le plan correctif ; éviter à l'avenir cette dette de sécurité en intégrant les exigences de sécurité dès le backlog refinement.`,
    `D. Demander au responsable sécurité de réaliser les tests en parallèle du développement sans impacter les sprints.`,
  ],
  correct:2,
  explication:`La réponse C est correcte. La dette de sécurité sur 4 sprints est un risque réel qui doit être traité — mais pas nécessairement en suspendant tout le développement (B, trop radical si les fonctionnalités ne traitent pas de données critiques). La priorisation par criticité des données permet de concentrer l'effort sur les fonctionnalités à plus haut risque. L'intégration immédiate des tests OWASP dans la DoF prévient la récurrence. Attendre la livraison finale (A) accumule une dette de sécurité potentiellement catastrophique.`,
},

{ id:"PR-060", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Vous gérez un projet de construction d'un entrepôt logistique (18 M€, 22 mois). À mois 10, vous réalisez que la route d'accès au chantier est insuffisante pour les convois exceptionnels qui livreront les charpentes métalliques dans 6 semaines (convois de 80 tonnes, route prévue pour 40 tonnes). Cette contrainte n'avait pas été identifiée lors de la phase de planification. Quel est votre plan d'action ?`,
  options:[
    `A. Demander aux transporteurs d'adapter leurs convois pour respecter les 40 tonnes — c'est leur responsabilité de s'adapter aux contraintes du chantier.`,
    `B. Évaluer les options techniques : renforcement temporaire de la route (coût, délai, faisabilité en 6 semaines), itinéraire alternatif, fractionnement des livraisons en éléments plus légers, ou reséquencement de l'activité charpente ; choisir l'option optimale en termes de coût/délai/faisabilité et la mettre en œuvre ; documenter le risque et identifier les mesures pour éviter ce type d'angle mort dans les futurs projets (checklists de contraintes d'accès).`,
    `C. Informer immédiatement le maître d'ouvrage que les charpentes ne pourront pas être livrées dans les délais prévus — la route est une contrainte extérieure non maîtrisable.`,
    `D. Contacter le fabricant de charpentes pour reporter la livraison de 3 mois le temps de renforcer la route.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Une contrainte d'accès non identifiée lors de la planification est une erreur de gestion des risques à corriger sans délai. L'analyse des options (renforcement, itinéraire alternatif, fractionnement, reséquencement) permet de choisir la solution la plus adaptée au contexte. Demander aux transporteurs de s'adapter (A) est irréaliste — les convois de 80 tonnes ne peuvent pas être réduits unilatéralement. Le report de 3 mois (D) sans exploration d'alternatives est disproportionné.`,
},

{ id:"PR-061", domaine:"Processus", approche:"Agile", type:"standard",
  question:`Vous êtes Scrum Master d'une équipe de 8 développeurs. Lors du sprint 11, deux membres décident unilatéralement d'utiliser un nouveau framework JavaScript non approuvé par l'équipe et non testé en production, pour développer un module critique. Ils l'ont déjà intégré dans 3 stories livrées ce sprint. Quelle est votre réaction ?`,
  options:[
    `A. Accepter le nouveau framework — l'innovation technique est une responsabilité de l'équipe et leur décision doit être respectée.`,
    `B. Faciliter une discussion d'équipe immédiate pour évaluer collectivement le risque (compatibilité, maintenance, courbe d'apprentissage pour les autres membres, support long terme) du nouveau framework sur les 3 stories déjà développées ; si le risque est jugé inacceptable, planifier la refactorisation dans le prochain sprint ; dans tous les cas, établir un protocole pour les futurs choix technologiques (évaluation collective, proof of concept, approbation avant intégration).`,
    `C. Demander aux deux membres de revenir immédiatement aux technologies approuvées et refaire les 3 stories.`,
    `D. Ignorer l'incident — si le code fonctionne, la technologie utilisée n'a pas d'importance.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. L'introduction unilatérale d'un framework non approuvé dans des stories critiques est un problème de gouvernance technique — pas d'innovation. La discussion collective permet d'évaluer objectivement le risque réel avant de décider si une refactorisation est nécessaire. Si le framework est en fait solide, l'équipe peut décider de l'adopter officiellement. L'annulation immédiate (C) sans évaluation peut être inutilement coûteuse si le risque est faible. L'acceptation sans discussion (A, D) normalise les décisions unilatérales non gouvernées.`,
},

{ id:"PR-062", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Dans un projet de construction d'une plateforme pétrolière offshore (340 M€, 48 mois), votre analyse de risques a identifié 3 scénarios de risques majeurs. La matrice de probabilité-impact place 2 risques en zone rouge (probabilité élevée, impact élevé) et 1 en zone orange. Le comité de direction vous demande de concentrer toutes les ressources de gestion des risques sur les 2 risques rouges. Êtes-vous d'accord ?`,
  options:[
    `A. Oui — la matrice de probabilité-impact est précisément conçue pour prioriser les risques et concentrer les ressources sur les plus critiques.`,
    `B. Partiellement — si le risque orange représente une menace existentielle pour le projet même avec une probabilité ou un impact modéré, il doit être inclus dans la gestion active. La matrice P×I est un outil de priorisation, pas une règle d'exclusion absolue. Recommander de gérer les 2 rouges en priorité tout en maintenant une surveillance active du risque orange et en préparant un plan de réponse minimal.`,
    `C. Non — tous les risques identifiés doivent recevoir la même attention, indépendamment de leur position dans la matrice.`,
    `D. Non — la matrice probabilité-impact est un outil obsolète et imprécis ; utiliser uniquement la VME pour prioriser les risques.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. La matrice P×I est un outil de priorisation utile mais pas une règle d'exclusion. Dans un projet de 340 M€ offshore à hauts enjeux, un risque "orange" peut néanmoins représenter une menace significative méritant une surveillance active et un plan de réponse de base. La gestion des risques n'est pas une activité "tout ou rien" — elle est proportionnée au niveau de risque. La VME (D) est complémentaire mais ne remplace pas entièrement la matrice P×I pour la communication avec les parties prenantes.`,
},

{ id:"PR-063", domaine:"Processus", approche:"Agile", type:"standard",
  question:`Votre équipe développe une application de gestion de ressources humaines. Le sprint 8 se termine avec 2 stories incomplètes (85 % du travail réalisé). Le Product Owner demande de les marquer "Done" pour améliorer les statistiques avant une présentation investisseurs demain. Que faites-vous ?`,
  options:[
    `A. Marquer les stories "Done" — à 85 %, elles sont quasiment terminées et la différence est négligeable pour les investisseurs.`,
    `B. Accepter si le PO confirme par écrit qu'il prend la responsabilité de cette décision.`,
    `C. Expliquer que marquer "Done" des stories incomplètes constitue une manipulation des données de performance qui induit les investisseurs en erreur ; proposer à la place de présenter honnêtement les 85 % d'avancement comme un indicateur positif — des investors sophistiqués apprécient la transparence plus que des chiffres gonflés. Reporter les 2 stories au sprint suivant selon la Définition de Fini.`,
    `D. Proposer un compromis : marquer les stories "In Review" plutôt que "Done" pour signaler qu'elles sont quasi-terminées.`,
  ],
  correct:2,
  explication:`La réponse C est correcte. Marquer des stories incomplètes "Done" falsifie les métriques de performance du projet — c'est une violation de l'honnêteté (Code d'Éthique PMI) et potentiellement une fraude envers des investisseurs si cela influence leurs décisions. La Définition de Fini est non négociable. Un "Done" qui ne l'est pas crée également une dette cachée. Les investisseurs sophistiqués valorisent la rigueur des données plus que des statistiques embellies. L'option D est un contournement partiel qui n'adresse pas le fond du problème éthique.`,
},

{ id:"PR-064", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Vous êtes chef de projet d'un programme de mise à niveau du système d'information d'un hôpital (35 M€, 36 mois). Le projet de remplacement du système de gestion des patients (DPI) est sur le chemin critique. À 4 mois de la mise en production, des tests d'intégration révèlent des problèmes de performance : les temps de réponse dans les urgences sont de 8 secondes (objectif < 2 secondes). Corriger le problème nécessite 3 mois. Comment gérez-vous cette situation dans un contexte de santé critique ?`,
  options:[
    `A. Mettre en production le système à 8 secondes de temps de réponse — les utilisateurs s'adapteront progressivement.`,
    `B. Reporter la mise en production de 3 mois pour corriger le problème de performance ; informer immédiatement la direction hospitalière de la situation et des raisons ; analyser si des optimisations rapides peuvent réduire partiellement le temps de réponse pendant la période de correction ; maintenir le système actuel opérationnel sans interruption pendant la période de correction.`,
    `C. Déployer le nouveau système dans les services non critiques (consultations, RH) et maintenir l'ancien système aux urgences jusqu'à la correction.`,
    `D. Demander aux urgentistes de participer aux tests de performance pour valider si 8 secondes est acceptable dans leur contexte réel.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Dans un contexte de santé critique, des temps de réponse de 8 secondes aux urgences (vs objectif de 2 secondes) constituent un risque patient inacceptable — une seconde peut être vitale dans un service d'urgences. Le report de 3 mois, bien que coûteux, est la seule décision éthiquement défendable. La transparence avec la direction hospitalière est obligatoire. L'option C (déploiement partiel) est créative mais les urgences sont précisément le service où la performance est la plus critique.`,
},

{ id:"PR-065", domaine:"Processus", approche:"Agile", type:"standard",
  question:`Dans votre équipe Scrum, vous utilisez le planning poker pour estimer les user stories. Lors d'une session d'estimation, l'équipe estime une story : les votes sont 3, 3, 3, 13, 3, 5, 3. Le vote de 13 vient d'un développeur senior expérimenté. L'équipe vote à nouveau après discussion sans que le développeur senior ait expliqué sa raison. Le deuxième vote donne 5, 5, 5, 8, 5, 5, 5. Quel problème illustre cette situation et comment le résolvez-vous ?`,
  options:[
    `A. La situation est normale — le deuxième tour a produit un consensus et l'estimation de 5 est validée.`,
    `B. Cette situation illustre le biais d'ancrage et la pression sociale — la majorité a convergé vers 5 sans vraiment comprendre pourquoi le senior avait voté 13. Faciliter une discussion où le senior explique précisément les risques ou complexités cachées qui justifiaient son 13 avant de finaliser l'estimation — son expertise peut avoir détecté une complexité réelle que les autres n'ont pas vue.`,
    `C. Le vote du développeur senior est outlier et doit être ignoré — le consensus de l'équipe prime.`,
    `D. Utiliser la médiane des votes (5) comme estimation finale — les outliers doivent être exclus statistiquement.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Le planning poker est conçu précisément pour révéler les divergences d'opinion et forcer une discussion sur les raisons — pas pour créer un consensus rapide. Un vote outlier de 13 d'un développeur senior mérite toujours une explication : il a peut-être identifié une dépendance cachée, une complexité technique sous-estimée ou un risque d'intégration. Ignorer l'outlier (C, D) ou accepter le consensus sans comprendre le 13 (A) passe à côté de l'information la plus précieuse du planning poker.`,
},

{ id:"PR-066", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Dans un projet de déploiement de panneaux solaires pour 500 foyers ruraux (6,2 M€, 20 mois), votre plan de qualité prévoit une inspection de chaque installation par un technicien certifié. À mois 12, vous réalisez que ce processus prend 3 fois plus de temps que prévu — mettant en péril le calendrier. Votre responsable qualité propose de passer à un contrôle par échantillonnage (10 % des installations). Comment évaluez-vous cette proposition ?`,
  options:[
    `A. Accepter immédiatement le contrôle par échantillonnage — c'est une méthode statistiquement valide et largement utilisée dans l'industrie.`,
    `B. Rejeter la proposition — chaque installation doit être inspectée individuellement car la sécurité des foyers ruraux ne peut pas être statistiquement approximée.`,
    `C. Évaluer la proposition de manière structurée : analyser le taux de défauts observé dans les 12 premiers mois (si < 1 %, l'échantillonnage à 10 % peut être statistiquement défendable ; si > 5 %, l'inspection complète reste nécessaire) ; vérifier si les réglementations locales autorisent l'échantillonnage pour ce type d'installation ; définir un protocole d'échantillonnage statistiquement robuste si adopté (aléatoire, représentatif géographiquement) ; obtenir l'accord du client et des autorités réglementaires avant tout changement de plan de qualité.`,
    `D. Adopter un contrôle par échantillonnage à 30 % comme compromis entre 10 % (insuffisant) et 100 % (trop lent).`,
  ],
  correct:2,
  explication:`La réponse C est correcte. La décision de passer à un contrôle par échantillonnage ne peut pas être prise unilatéralement — elle dépend du taux de défauts observé, de la réglementation applicable et de l'accord du client. L'échantillonnage statistique peut être valide (c'est la base du contrôle qualité industriel) mais doit être correctement dimensionné et approuvé. L'acceptation immédiate (A) sans analyse est imprudente. Le rejet catégorique (B) ignore que l'échantillonnage est une méthode légitime si le taux de défauts est faible. Le 30 % arbitraire (D) n'est pas fondé sur une analyse statistique.`,
},

{ id:"PR-067", domaine:"Processus", approche:"Agile", type:"standard",
  question:`Votre équipe Scrum travaille en remote sur 3 fuseaux horaires. Au sprint 10, vous constatez que les stories "Done" au sprint review présentent systématiquement des problèmes d'intégration découverts lors des tests end-to-end — des problèmes qui n'existaient pas quand l'équipe travaillait en présentiel. L'analyse révèle que les développeurs testent leurs fonctionnalités en isolation mais que les tests d'intégration entre composants ne sont pas réalisés avant le sprint review. Quelle est votre approche ?`,
  options:[
    `A. Revenir au présentiel — les équipes distribuées ne peuvent pas maintenir la même qualité d'intégration qu'en présentiel.`,
    `B. Renforcer la Définition de Fini pour inclure des tests d'intégration obligatoires avant de marquer une story "Done" ; mettre en place un environnement d'intégration continue partagé (CI/CD) accessible à tous les membres en temps réel ; planifier une session de travail synchrone quotidienne de 30 minutes en période de chevauchement des fuseaux horaires pour les intégrations critiques.`,
    `C. Créer une phase d'intégration de 1 semaine en fin de chaque sprint où un membre dédié réalise tous les tests d'intégration.`,
    `D. Accepter les problèmes d'intégration comme inhérents au travail en remote et augmenter la durée des sprints de 2 à 3 semaines pour absorber le temps de correction.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Les problèmes d'intégration en équipe remote révèlent un manque d'intégration continue — le code est développé en silos. La solution systémique combine une DoF renforcée (tests d'intégration avant "Done"), un environnement CI/CD partagé (feedback immédiat sur les intégrations) et une synchronisation quotidienne courte pour les intégrations critiques. La phase d'intégration dédiée (C) reproduit le modèle cascade à l'intérieur du sprint. Allonger les sprints (D) sans adresser la cause racine ne résout rien.`,
},

{ id:"PR-068", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Dans un projet de construction d'une usine de recyclage (28 M€, 30 mois), votre responsable HSE vous informe que les procédures de sécurité pour la manipulation des matériaux dangereux (batteries lithium usagées) ne sont pas encore validées par l'inspection du travail, alors que les travaux d'installation des équipements de traitement démarrent dans 3 semaines. Il estime que la validation prendra 6 à 8 semaines. Comment gérez-vous cette situation ?`,
  options:[
    `A. Démarrer les travaux d'installation selon le planning prévu — les procédures seront validées pendant l'installation, avant la mise en service opérationnelle.`,
    `B. Retarder uniquement les activités impliquant la manipulation directe de batteries lithium jusqu'à validation des procédures ; continuer les autres travaux d'installation ; accélérer le processus de validation en travaillant en étroite collaboration avec l'inspection du travail (documentation complète soumise immédiatement, disponibilité pour les visites d'inspection) ; informer le maître d'ouvrage du retard partiel et de son impact sur le calendrier global.`,
    `C. Démarrer les travaux avec des procédures temporaires internes en attendant la validation officielle — la sécurité des ouvriers sera assurée par des mesures compensatoires renforcées.`,
    `D. Suspendre l'intégralité du chantier jusqu'à l'obtention de la validation — aucun travail ne peut démarrer sans toutes les validations de sécurité requises.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. La gestion pragmatique du risque réglementaire permet de minimiser l'impact sur le planning tout en respectant les obligations légales. Continuer les travaux sans risque (hors manipulation de batteries) tout en accélérant la validation est la stratégie optimale. Démarrer avec des procédures temporaires (C) est une prise de risque légal et humain inacceptable — les procédures non validées exposent les ouvriers ET l'entreprise à des sanctions. La suspension totale (D) est disproportionnée si seule une partie des travaux est concernée.`,
},

{ id:"PR-069", domaine:"Processus", approche:"Agile", type:"standard",
  question:`Dans votre équipe Scrum de 9 personnes, le taux de turnover est de 33 % par an (3 membres remplacés chaque année). Vous constatez que chaque départ et arrivée crée une perturbation de 2-3 sprints. Comment réduisez-vous systématiquement l'impact du turnover sur la productivité de l'équipe ?`,
  options:[
    `A. Réduire le turnover — le problème est la rétention des membres, pas le processus d'intégration.`,
    `B. Constituer une documentation complète et maintenue à jour de tous les processus de l'équipe — si tout est documenté, les départs et arrivées seront transparents.`,
    `C. Mettre en place un programme structuré de gestion du turnover : (1) documentation vivante des pratiques, décisions d'architecture et contexte projet dans le repository ; (2) binômage systématique (chaque membre a un backup qui comprend son périmètre) ; (3) protocole d'onboarding standardisé de 2 sprints pour les nouveaux membres ; (4) rétrospective dédiée "knowledge transfer" lors de chaque départ annoncé ; (5) maintenir l'attractivité de l'équipe pour réduire le turnover lui-même.`,
    `D. Recruter des profils très juniors qui s'adaptent rapidement sans préconçus et coûtent moins cher à remplacer.`,
  ],
  correct:2,
  explication:`La réponse C est correcte. Le turnover de 33 % est une réalité à gérer systémiquement, pas seulement à subir ou à attribuer à un seul facteur. Le programme en 5 points adresse simultanément la résilience organisationnelle (binômage, documentation) et la fluidité de transition (protocole d'onboarding, knowledge transfer). La documentation seule (B) est nécessaire mais insuffisante. Réduire le turnover (A) est un objectif légitime mais ne résout pas le problème à court terme. Le recrutement de profils très juniors (D) aggrave le problème de qualité et de continuité.`,
},

{ id:"PR-070", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Vous gérez un projet de développement d'une plateforme de paiement mobile (22 M€, 30 mois). Votre équipe de testing a découvert, 2 semaines avant la mise en production, que le système peut traiter des transactions négatives (permettant théoriquement à un utilisateur de se créditer lui-même de l'argent). La correction prend 3 semaines. Le lancement a été annoncé publiquement. Quelle est votre décision ?`,
  options:[
    `A. Lancer selon le planning prévu avec une surveillance renforcée — la probabilité d'exploitation est faible et la correction sera déployée rapidement.`,
    `B. Reporter le lancement de 3 semaines pour corriger la vulnérabilité ; communiquer publiquement un report "pour des raisons de qualité" sans détailler la nature de la faille ; activer le protocole de gestion de crise de sécurité interne.`,
    `C. Lancer en accès limité (version bêta fermée à 100 utilisateurs de confiance) pendant les 3 semaines de correction — cela maintient la date de lancement public tout en limitant l'exposition.`,
    `D. Lancer selon le planning en bloquant techniquement les transactions négatives par une règle de validation côté serveur temporaire (patch de 2 jours) en attendant la correction complète.`,
  ],
  correct:3,
  explication:`La réponse D est correcte. Un patch de validation côté serveur (bloquer les transactions négatives) est une mesure corrective rapide (2 jours) qui neutralise la vulnérabilité sans reporter le lancement. Cette approche est commune dans l'industrie des paiements — le patch traite le vecteur d'attaque immédiatement, la correction complète consolide la solution. La version bêta fermée (C) est une alternative acceptable mais ne respecte pas l'annonce publique. Lancer sans protection (A) est irresponsable dans une plateforme de paiement. Le report de 3 semaines (B) sans patch temporaire n'est pas nécessaire si le patch est disponible rapidement.`,
},

{ id:"PR-071", domaine:"Processus", approche:"Agile", type:"standard",
  question:`Vous gérez un programme Agile à grande échelle avec 5 équipes Scrum. Les équipes A et C ont des dépendances techniques sur 3 composants partagés développés par l'équipe B. L'équipe B est régulièrement en retard dans la livraison de ces composants, bloquant les équipes A et C. Le Release Train Engineer (RTE) constate que l'équipe B est la plus chargée du programme et travaille déjà à 110 % de sa capacité. Quelle est la solution systémique recommandée ?`,
  options:[
    `A. Augmenter la pression sur l'équipe B pour qu'elle livre dans les délais — si les autres équipes sont bloquées, l'équipe B doit prioriser leurs besoins.`,
    `B. Rééquilibrer la charge au niveau du programme : redistribuer certains composants partagés vers l'équipe A ou C (réduire la dépendance sur B), ou créer une 6ème équipe dédiée aux composants partagés, ou augmenter la capacité de l'équipe B (recrutement) ; reséquencer les PI Objectives pour réduire les dépendances critiques sur B dans le PI courant ; les dépendances sur un seul composant partagé sont un anti-pattern architectural à adresser à moyen terme (microservices, API contracts).`,
    `C. Demander aux équipes A et C de travailler sur d'autres stories pendant que B rattrape son retard.`,
    `D. Réduire la vélocité attendue des équipes A et C pour tenir compte des blocages récurrents — intégrer le blocage comme une contrainte fixe du programme.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Un goulot persistant sur l'équipe B est un problème systémique — augmenter la pression (A) sur une équipe déjà à 110 % est contre-productif et crée des risques de qualité et de turnover. La solution systémique combine les actions à court terme (reséquencement des PI Objectives, redistribution des composants) avec les actions à moyen terme (architecture moins couplée). Travailler sur d'autres stories (C) peut être un palliatif temporaire mais n'est pas une solution. Réduire les attentes (D) accepte le problème sans le résoudre.`,
},

{ id:"PR-072", domaine:"Processus", approche:"Prédictif", type:"standard",
  question:`Dans un projet de construction d'un complexe sportif (45 M€, 36 mois), votre audit de mi-projet révèle que les communications entre l'architecte, l'ingénieur structure et l'entreprise générale ont généré 23 demandes de clarification non résolues qui bloquent des décisions de conception. Certaines remontent à 4 mois. Le délai cumulé de ces clarifications est estimé à 6 semaines sur le chemin critique. Comment résolvez-vous cette situation ?`,
  options:[
    `A. Organiser une réunion hebdomadaire de coordination tripartite (architecte, ingénieur, entreprise générale) pour résoudre les 23 points ouverts dans les 4 prochaines semaines.`,
    `B. Analyser les 23 demandes par urgence et impact sur le chemin critique ; convoquer immédiatement une réunion de résolution intensive (2 jours) avec les 3 parties et un facilitateur pour traiter les 8-10 points les plus bloquants ; déléguer les décisions si certains points sont bloqués par des absences de personnes clés ; mettre en place un système de suivi des demandes ouvertes avec délai de réponse maximal de 48h et escalade automatique au chef de projet si non répondu.`,
    `C. Désigner l'architecte comme coordinateur unique responsable de résoudre toutes les demandes de clarification — il est le maître d'œuvre et cette responsabilité lui appartient.`,
    `D. Accepter le retard de 6 semaines et soumettre une demande d'extension au maître d'ouvrage — les délais de clarification entre professionnels sont hors du contrôle du chef de projet.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. 23 demandes ouvertes dont certaines remontent à 4 mois révèlent une défaillance du processus de communication et de décision entre les intervenants. La réunion intensive (2 jours) est plus efficace pour débloquer la situation qu'une cadence hebdomadaire (A) qui prendrait 4+ semaines. La priorisation par impact sur le chemin critique permet de concentrer l'énergie sur les points les plus urgents. Le système de suivi avec escalade automatique prévient la récurrence. Déléguer à l'architecte (C) ne change pas la dynamique si la communication tripartite est le problème.`,
},

// ── ENV D'AFFAIRES supplémentaires ──────────────────────────────

{ id:"EA-028", domaine:"Environnement d'affaires", approche:"Prédictif", type:"standard",
  question:`Vous gérez un projet de mise à niveau du système de contrôle d'une centrale nucléaire (120 M€, 60 mois). À mois 36, votre analyse identifie que les tests de validation du nouveau système de contrôle révèlent des écarts avec les spécifications de sûreté approuvées par l'autorité de sûreté nucléaire (ASN). Les écarts sont mineurs selon votre équipe technique mais formellement non conformes aux exigences ASN. Quelle est votre action immédiate ?`,
  options:[
    `A. Documenter les écarts et les évaluer avec votre équipe technique avant d'informer l'ASN — comprendre les faits avant de créer une alarme inutile.`,
    `B. Informer immédiatement l'ASN des écarts identifiés, même mineurs selon votre propre évaluation technique ; l'ASN est seule compétente pour qualifier ces écarts (mineurs ou non) au regard de la sûreté nucléaire ; soumettre un rapport de non-conformité selon le processus réglementaire requis et attendre les instructions de l'ASN avant de poursuivre les tests.`,
    `C. Corriger les écarts immédiatement sans en informer l'ASN — si les écarts sont résolus avant la prochaine inspection, il n'y a pas de non-conformité officielle.`,
    `D. Consulter votre service juridique pour évaluer vos obligations de déclaration avant d'agir — les implications légales d'une déclaration à l'ASN peuvent être significatives.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Dans le secteur nucléaire, les obligations de déclaration des écarts aux autorités de sûreté sont légalement et réglementairement strictes et non discrétionnaires. L'évaluation "mineure" par l'équipe technique du projet n'est pas pertinente — seule l'ASN est habilitée à qualifier l'impact sécurité d'un écart sur un système de contrôle de centrale. Retarder (A) ou masquer (C) des écarts non conformes aux spécifications ASN constitue une infraction grave. La consultation juridique (D) ne peut pas précéder les obligations de notification réglementaires.`,
},

{ id:"EA-029", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  question:`Votre startup développe une application de crédit pour micro-entrepreneurs en Afrique de l'Ouest. Le modèle de crédit scoring est basé sur les transactions mobiles et les comportements d'achat. Lors d'un sprint review avec votre partenaire investisseur, celui-ci suggère d'intégrer les données de localisation GPS en temps réel pour "affiner le scoring". L'équipe est enthousiaste. Comment évaluez-vous cette suggestion ?`,
  options:[
    `A. Intégrer les données GPS immédiatement — plus de données améliore toujours la précision des modèles de crédit.`,
    `B. Freiner l'enthousiasme et analyser la proposition selon plusieurs dimensions : (1) pertinence prédictive réelle des données GPS pour le risque de crédit vs données financières directes ; (2) obligations légales (consentement explicite, limitation de la collecte selon les lois de protection des données applicables) ; (3) risques de discrimination indirecte (les patterns de localisation peuvent être des proxies de variables protégées — ethnie, religion, niveau socio-économique) ; (4) proportionnalité (est-ce que le gain de précision justifie la collecte de données de localisation en temps réel ?) — et soumettre la proposition au DPO avant toute décision technique.`,
    `C. Tester l'intégration GPS sur un sous-échantillon d'utilisateurs volontaires pour évaluer le gain de précision avant de décider.`,
    `D. Accepter uniquement les données GPS historiques (pas temps réel) qui sont moins intrusives tout en apportant des informations de localisation utiles.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. L'intégration de données GPS dans un modèle de crédit scoring soulève des questions sérieuses : pertinence réelle pour le risque de crédit, obligations légales de consentement, risques de discrimination indirecte (les patterns de mobilité peuvent corréler avec des facteurs ethniques ou socio-économiques). L'enthousiasme technique ne dispense pas de l'analyse éthique et légale préalable. Le DPO doit être impliqué. Le test sur volontaires (C) est une approche de recherche, pas un substitut à l'analyse légale et éthique préalable.`,
},

{ id:"EA-030", domaine:"Environnement d'affaires", approche:"Prédictif", type:"standard",
  question:`Vous êtes directeur de programme d'un programme stratégique de diversification d'un groupe industriel (280 M€, 5 ans). Le groupe traverse une crise de liquidité imprévue liée à une baisse des prix mondiaux de ses matières premières. Le CFO propose de suspendre 2 des 5 projets du programme pour libérer 45 M€ de trésorerie sur 18 mois. Comment conduisez-vous l'analyse de la décision de suspension ?`,
  options:[
    `A. Suspendre les 2 projets avec le plus faible ROI selon le business case initial — la décision est simple et objective.`,
    `B. Conduire une analyse multi-critères approfondie : valeur stratégique de chaque projet (alignement avec la vision diversification, irréversibilité — certains avantages concurrentiels se perdent si on s'arrête), coût de suspension et de reprise (un projet à 40 % d'avancement suspendu peut perdre 30-50 % de sa valeur), liquidités libérées par projet et délai de libération, risques de perte définitive d'opportunités marché. Présenter au comité de direction 2-3 scénarios de suspension différents avec leurs coûts et implications stratégiques à 5 ans — et recommander le scénario qui préserve le mieux la valeur stratégique à long terme.`,
    `C. Suspendre les 2 projets les moins avancés — l'investissement déjà réalisé dans les projets avancés est un coût irrécupérable qu'il faut protéger.`,
    `D. Recommander de ne suspendre aucun projet et de chercher des financements alternatifs (dette, cession d'actifs non stratégiques) pour préserver l'intégrité du programme.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. La décision de suspendre des projets dans un programme stratégique ne peut pas être réduite à un critère unique (ROI, avancement). L'analyse multi-critères doit intégrer la valeur stratégique (la diversification peut être vitale pour la résilience du groupe à long terme), le coût réel de suspension/reprise (souvent sous-estimé), et les risques d'irréversibilité des opportunités. Les scénarios présentés au comité de direction doivent être clairs sur les trade-offs à long terme. La logique du "coût irrécupérable" (C) est une erreur classique — ce qui a déjà été dépensé ne doit pas dicter les décisions futures.`,
},

{ id:"EA-031", domaine:"Environnement d'affaires", approche:"Hybride", type:"standard",
  question:`Vous êtes chef de projet pour la mise en place d'un système de gestion des ressources naturelles (eau, forêts) dans une région rurale d'Afrique centrale (financement ONU, 12 M€, 36 mois). À mois 18, votre évaluation à mi-parcours révèle que les communautés locales n'ont pas adopté le système de reporting numérique prévu — elles continuent leurs méthodes traditionnelles. L'adoption est de 12 % (objectif : 70 %). L'analyse révèle que 68 % des responsables communautaires ciblés ne maîtrisent pas les outils numériques et que la connectivité internet est inférieure à 30 % dans la zone. Ces contraintes n'avaient pas été correctement évaluées lors de la conception. Comment redirigez-vous le projet ?`,
  options:[
    `A. Intensifier la formation numérique pour atteindre l'objectif de 70 % — les communautés peuvent apprendre si on leur donne suffisamment de formation.`,
    `B. Reconnaître que le design du projet était inadapté aux contraintes réelles du terrain ; proposer au bailleur ONU une révision fondamentale de l'approche : remplacer le reporting numérique par un système hybride (collecte de données par des agents locaux formés sur application offline synchronisée lors des visites en zones connectées + méthodes papier pour les zones les plus isolées) ; intégrer les méthodes traditionnelles existantes comme données d'entrée valides ; réviser les objectifs d'adoption à 40-50 % pour la composante numérique et définir des indicateurs alternatifs pour les zones non connectées.`,
    `C. Déplacer le projet vers les zones à meilleure connectivité pour atteindre les objectifs d'adoption — adapter la géographie plutôt que l'approche.`,
    `D. Clore le projet à mi-parcours et reconnaître l'échec de conception — continuer avec une approche inadaptée gaspille les fonds ONU.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Ce cas illustre un problème classique de projets de développement : la conception est faite sans validation suffisante des contraintes terrain (connectivité, compétences numériques). La révision fondamentale de l'approche (système hybride offline/online, intégration des méthodes traditionnelles) est la réponse appropriée. Elle respecte l'objectif de gestion des ressources naturelles tout en adaptant les méthodes aux réalités locales. L'intensification de la formation (A) sans adresser la contrainte de connectivité ne résoudra pas le problème. La cloture (D) après 12 M€ d'investissement et 18 mois sans explorer les alternatives est prématurée.`,
},

{ id:"EA-032", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  question:`Votre organisation développe une plateforme de e-commerce. Un concurrent vient de lancer un produit similaire avec une fonctionnalité d'IA de recommandation très appréciée des utilisateurs. Le CEO veut que vous "copiez cette fonctionnalité" dans les 3 prochains sprints. Votre analyse montre que développer une IA de recommandation de qualité équivalente nécessite 8-12 sprints minimum. Comment gérez-vous cette pression ?`,
  options:[
    `A. Livrer une version minimale de recommandation (règles heuristiques simples) présentée comme "IA de recommandation" pour satisfaire la demande du CEO dans les délais.`,
    `B. Présenter au CEO une analyse honnête : l'IA de recommandation de qualité compétitive nécessite des données d'entraînement (historique d'achats), une infrastructure ML, et 8-12 sprints de développement minimum ; proposer un plan en 2 temps : (1) dans 3 sprints, livrer une version de recommandations basées sur des règles métier (comportements populaires, produits complémentaires) clairement positionnée comme "recommandations intelligentes" — pas comme "IA" ; (2) développer une vraie IA de recommandation sur 8 sprints en parallèle pour un avantage différentiateur durable.`,
    `C. Copier exactement l'interface et l'UX du concurrent — l'expérience utilisateur peut être reproduite même si l'IA sous-jacente est différente.`,
    `D. Recruter immédiatement 3 data scientists pour livrer l'IA de recommandation en 4 sprints — avec plus de ressources, le délai peut être compressé.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Elle est honnête (évite de "vendre" des heuristiques simples comme de l'IA), pragmatique (livrer quelque chose de valeur dans 3 sprints) et stratégique (plan sur 8 sprints pour une vraie IA compétitive). Présenter des règles heuristiques comme de l'IA (A) constitue une tromperie des utilisateurs et potentiellement du marché. Copier l'interface (C) sans la fonctionnalité crée une expérience dégradée. Recruter pour compresser (D) ignore que le développement ML nécessite des données et itérations, pas seulement plus de ressources.`,
},

{ id:"EA-033", domaine:"Environnement d'affaires", approche:"Prédictif", type:"standard",
  question:`Dans un programme de transformation d'une compagnie d'assurance (58 M€, 42 mois), la cartographie des parties prenantes révèle que le syndicat des agents d'assurance (représentant 2 400 agents) n'a pas été consulté lors de la définition du programme qui prévoit le remplacement partiel des agents par des outils de souscription automatisée. Vous êtes nommé chef de programme 8 mois après le lancement. Comment gérez-vous cette lacune de gestion des parties prenantes ?`,
  options:[
    `A. Continuer le programme sans consulter le syndicat — le programme a été approuvé avant votre nomination et la consultation rétroactive crée des risques inutiles.`,
    `B. Prendre l'initiative de consulter rapidement le syndicat pour comprendre leurs préoccupations et présenter les impacts réels du programme sur les agents (quels emplois sont affectés ? quelles nouvelles compétences seront nécessaires ? quel plan d'accompagnement est prévu ?) ; si aucun plan d'accompagnement n'existe, en développer un avec les RH ; intégrer formellement le syndicat comme partie prenante dans la gouvernance du programme ; être honnête sur les impacts de la transformation tout en présentant les mesures d'accompagnement.`,
    `C. Mandater un consultant en relations sociales pour gérer la relation syndicale — c'est une compétence spécialisée qui dépasse le rôle du chef de programme.`,
    `D. Attendre que le syndicat manifeste son opposition avant d'agir — agir en amont peut éveiller des inquiétudes qui n'existent pas encore.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Une transformation qui affecte 2 400 agents sans consultation syndicale est un risque social majeur qui peut paralyser le programme (grèves, recours juridiques, résistance passive des agents). La consultation proactive — même tardive — est meilleure que d'attendre une crise. Le chef de programme a la responsabilité d'intégrer cette partie prenante critique dans la gouvernance, quelle que soit la situation héritée. Attendre l'opposition (D) laisse la situation se dégrader. La délégation complète à un consultant (C) est insuffisante — le chef de programme doit être personnellement impliqué.`,
},

{ id:"EA-034", domaine:"Environnement d'affaires", approche:"Hybride", type:"standard",
  question:`Vous êtes chef de projet pour la construction d'une centrale hydroélectrique de 85 MW (180 M€, 54 mois) dans un pays d'Afrique subsaharienne. Une ONG internationale publie un rapport accusant votre projet d'avoir causé le déplacement involontaire de 340 familles villageoises sans compensation adéquate. Le rapport est partiellement exact (180 familles ont été déplacées mais ont reçu des compensations) et partiellement inexact (les 160 autres familles ont été déplacées AVANT votre projet par une autre infrastructure). Comment répondez-vous ?`,
  options:[
    `A. Publier un communiqué niant toutes les accusations — certaines sont fausses et l'ensemble doit être contesté.`,
    `B. Ignorer le rapport — les ONG publient régulièrement des rapports partiaux et y répondre leur donne plus de visibilité.`,
    `C. Répondre de manière factuelle, transparente et différenciée : reconnaître publiquement et honnêtement le déplacement des 180 familles (fact), présenter les compensations versées et leur adéquation, proposer si nécessaire un audit indépendant du processus de compensation ; clarifier factuellement l'erreur concernant les 160 familles déplacées avant le projet (avec preuves documentaires) ; s'engager à renforcer les consultations communautaires pour la suite du projet.`,
    `D. Contacter l'ONG en privé pour corriger les erreurs factuelles avant toute réponse publique — une correction discrète est préférable à un débat public.`,
  ],
  correct:2,
  explication:`La réponse C est correcte. Face à un rapport d'ONG partiellement exact, la réponse doit être factuelle, honnête et différenciée — ni le déni total (A), ni l'ignorance (B). Reconnaître la réalité du déplacement des 180 familles (avec les compensations versées) tout en corrigeant l'erreur factuelle sur les 160 autres (avec preuves) est la seule approche crédible. Un audit indépendant des compensations démontre la bonne foi. La correction discrète (D) ne satisfait pas les parties prenantes publiques (bailleurs, médias, riverains) qui ont lu le rapport.`,
},

{ id:"EA-035", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  question:`Votre startup EdTech a levé des fonds sur la base d'un business case projetant 50 000 utilisateurs payants à 18 mois. Après 15 mois de développement Agile, vous avez 8 400 utilisateurs payants. Votre prochain sprint review coïncide avec un point d'étape avec vos investisseurs. Comment présentez-vous honnêtement cette situation ?`,
  options:[
    `A. Présenter uniquement les indicateurs positifs (croissance mensuelle, taux de rétention, NPS) pour maintenir la confiance des investisseurs — les 50 000 utilisateurs seront atteints avec du temps.`,
    `B. Présenter une analyse complète et honnête : 8 400 vs 50 000 utilisateurs (17 % de l'objectif à 15 mois sur 18) ; analyse causale (acquisition plus lente que prévu : quel canal ? quelle conversion ? quel CAC réel vs estimé ?) ; révision des projections à 18 mois (estimation réaliste : 12 000-15 000 utilisateurs) ; plan d'action pour accélérer l'acquisition (pivots, partenariats, nouveaux canaux) ; besoins de financement révisés pour atteindre la viabilité. La transparence avec les investisseurs est à la fois légalement requise et stratégiquement optimale pour maintenir leur confiance.`,
    `C. Demander un report du point d'étape de 3 mois pour se donner plus de temps d'atteindre les objectifs.`,
    `D. Réviser rétroactivement l'objectif dans la présentation de 50 000 à 15 000 utilisateurs et présenter 8 400 comme quasi-conforme à ce nouvel objectif révisé.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. La transparence avec les investisseurs n'est pas seulement une obligation éthique — c'est une obligation légale dans la plupart des juridictions (information matérielle). Un écart de 83 % sur un objectif clé est une information que les investisseurs ont le droit de connaître pour décider de leur accompagnement futur. L'honnêteté précoce préserve mieux la relation de confiance que la découverte tardive d'une dissimulation. La révision rétroactive (D) est une fraude. Présenter uniquement les positifs (A) est trompeur. Reporter (C) aggrave l'écart sans changer la réalité.`,
},

{ id:"EA-036", domaine:"Environnement d'affaires", approche:"Prédictif", type:"standard",
  question:`Vous êtes chef de projet pour la mise en conformité IFRS 17 d'une compagnie d'assurance (15 M€, 24 mois). La norme IFRS 17 entre en vigueur dans 6 mois et votre projet accuse un retard de 4 mois dû à des complexités actuarielles imprévues. Une non-conformité à la date d'entrée en vigueur pourrait entraîner des sanctions réglementaires de 2-5 M€ et une dégradation de la notation financière de la compagnie. Votre analyse montre qu'en mobilisant 6 consultants actuariels supplémentaires pendant 4 mois, vous pouvez être conformes à temps (coût additionnel : 1,8 M€). Comment présentez-vous cette décision au conseil d'administration ?`,
  options:[
    `A. Recommander de mobiliser les 6 consultants sans présenter l'alternative de non-conformité — la conformité est non négociable.`,
    `B. Présenter l'analyse de décision complète : option 1 (mobiliser 6 consultants = 1,8 M€ additionnel, conformité garantie) vs option 2 (ne pas mobiliser = risque de sanction réglementaire de 2-5 M€ + impact notation financière + risque de réputation). La VME de l'option 2 = probabilité de non-conformité partielle × coût de la sanction. L'analyse montre clairement que l'option 1 (1,8 M€ certain) est économiquement et stratégiquement supérieure à l'option 2 (risque de 2-5 M€ + notation). Recommander l'option 1 avec cette justification.`,
    `C. Demander une extension de délai à l'autorité de régulation — les régulateurs accordent généralement des délais de grâce pour des raisons techniques documentées.`,
    `D. Réduire le périmètre de conformité IFRS 17 aux éléments les plus critiques pour respecter la date d'entrée en vigueur, quitte à avoir une conformité partielle.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Présenter la décision de mobiliser des ressources supplémentaires avec une analyse coût-bénéfice complète donne au CA les éléments pour approuver en connaissance de cause — et l'analyse est ici clairement favorable à l'investissement de 1,8 M€ face à un risque de 2-5 M€. Le CA doit comprendre pourquoi cette dépense imprévue est économiquement justifiée. Recommander sans justification (A) peut être refusé. Demander une extension (C) aux régulateurs est incertain et publie l'incapacité à se conformer. La conformité partielle (D) peut quand même entraîner des sanctions.`,
},

{ id:"EA-037", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  question:`Vous gérez le développement d'une application mobile de livraison de repas. Après 14 sprints, votre analyse de la valeur livrée révèle que les fonctionnalités de suivi en temps réel (développées aux sprints 4-7, représentant 35 % de la vélocité investie) sont utilisées par seulement 12 % des utilisateurs actifs, tandis que la fonctionnalité de commande récurrente (développée au sprint 13, 8 % de la vélocité) est utilisée par 71 % des utilisateurs. Comment intégrez-vous cet apprentissage dans votre stratégie produit ?`,
  options:[
    `A. Continuer selon le plan initial — les métriques d'usage à 14 sprints sont prématurées pour décider d'une réorientation.`,
    `B. Présenter cette analyse au Product Owner comme un signal important : les 35 % de vélocité investis dans le suivi temps réel génèrent une utilisation de 12 % vs 8 % de vélocité pour la commande récurrente générant 71 % d'utilisation — le ROI fonctionnel est radicalement différent. Recommander de recentrer le backlog sur les fonctionnalités à fort usage (commande récurrente, personnalisation, fidélisation) et de réduire l'investissement dans les fonctionnalités peu utilisées. Conduire des tests utilisateurs pour comprendre POURQUOI le suivi temps réel est peu utilisé (UX insuffisante ? besoin non réel ? fonctionnalité trop cachée ?).`,
    `C. Supprimer les fonctionnalités de suivi temps réel du produit pour simplifier l'application.`,
    `D. Investir davantage dans l'amélioration UX du suivi temps réel pour augmenter son adoption — la fonctionnalité est précieuse mais mal accessible.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. L'analyse de l'utilisation réelle des fonctionnalités est l'une des métriques les plus précieuses en Agile — elle révèle les écarts entre valeur supposée (lors de la planification) et valeur réelle (mesurée par l'usage). La recommandation de recentrer le backlog vers les fonctionnalités à fort impact ne signifie pas supprimer (C) le suivi temps réel, mais réduire l'investissement relatif. Comprendre POURQUOI le suivi temps réel est peu utilisé (D est partiellement correct) est une question légitime — mais sans cette compréhension préalable, investir davantage risque de creuser un puits dans le mauvais endroit.`,
},

{ id:"EA-038", domaine:"Environnement d'affaires", approche:"Prédictif", type:"standard",
  question:`Vous êtes chef de programme pour un programme de modernisation du système judiciaire d'un pays (45 M€, 48 mois), financé par la Banque Mondiale. À mois 30, votre évaluation intermédiaire obligatoire révèle des progrès mitigés : les indicateurs de performance judiciaire (délais de traitement des dossiers, taux de numérisation) sont en amélioration de 15-20 % mais bien en dessous des objectifs contractuels (50-60 %). La Banque Mondiale envisage de suspendre les décaissements futurs. Comment préparez-vous cette évaluation ?`,
  options:[
    `A. Présenter les résultats de la façon la plus favorable possible pour éviter la suspension des décaissements — les résultats partiels peuvent encore s'améliorer.`,
    `B. Préparer une présentation honnête et analytique : faits (15-20 % d'amélioration vs 50-60 % objectif) ; analyse causale des écarts (facteurs internes contrôlables : formation insuffisante des magistrats, résistances au changement ; facteurs externes : instabilité politique, contraintes budgétaires nationales, COVID-19 impact) ; réalisations qualitatives non capturées par les KPIs quantitatifs ; plan correctif révisé pour les 18 mois restants avec jalons intermédiaires trimestriels ; recommandation de votre propre chef sur la continuation du programme (si le plan correctif est crédible) ou sur les ajustements nécessaires — et accepter honnêtement la décision de la Banque Mondiale.`,
    `C. Demander une révision des indicateurs de performance à la baisse pour que les résultats actuels soient dans les cibles — les objectifs initiaux étaient trop ambitieux.`,
    `D. Solliciter une extension de programme de 12 mois sans décaissement supplémentaire pour permettre aux résultats de se matérialiser.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Préparer une présentation honnête et analytique d'une évaluation mi-parcours difficile est la seule approche éthique et professionnellement défendable vis-à-vis d'un bailleur international comme la Banque Mondiale. L'analyse causale différenciant les facteurs contrôlables (à corriger) des facteurs exogènes (à documenter) est indispensable pour que la Banque Mondiale prenne une décision éclairée. La présentation favorable (A) peut conduire à des décaissements supplémentaires sur un programme mal orienté. La révision des indicateurs (C) est une manipulation des données de performance.`,
},

{ id:"EA-039", domaine:"Environnement d'affaires", approche:"Hybride", type:"standard",
  question:`Vous êtes chef de projet pour le développement d'un système d'information géographique (SIG) pour la gestion des terres agricoles dans une région de 450 000 ha (6,8 M€, 24 mois). À mi-projet, vous découvrez que les données cadastrales fournies par l'administration (base de votre système) présentent des erreurs significatives dans 23 % des parcelles, rendant ces données inexploitables pour les décisions de gestion agricole. L'acquisition de données précises par relevés terrain coûterait 1,8 M€ supplémentaires et 8 mois. Comment gérez-vous cette situation ?`,
  options:[
    `A. Livrer le système avec les données disponibles (77 % fiables) et documenter les zones d'erreur — un système imparfait est mieux que pas de système.`,
    `B. Analyser la distribution géographique des erreurs (23 % répartis uniformément ou concentrés dans certaines zones ?) ; si concentrées dans des zones prioritaires agricoles, réaliser les relevés terrain uniquement sur ces zones (coût réduit) ; si distribuées aléatoirement, proposer au commanditaire les options : (1) système avec données partielles + avertissement utilisateurs sur les zones incertaines, (2) extension budget/délai pour corrections terrain, (3) partenariat avec organisations agricoles locales pour corriger progressivement les données ; revoir les indicateurs de succès du projet pour refléter la réalité des données disponibles.`,
    `C. Demander à l'administration de corriger ses données cadastrales avant de continuer — elle est responsable de la qualité des données qu'elle fournit.`,
    `D. Suspendre le projet jusqu'à obtenir des données fiables — un SIG basé sur des données incorrectes à 23 % est inutilisable.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. La distribution géographique des erreurs est l'information clé qui détermine la stratégie : des erreurs concentrées dans des zones précises permettent une correction ciblée économique ; des erreurs distribuées nécessitent une approche différente. Proposer plusieurs options au commanditaire permet une décision éclairée sur le compromis qualité/coût/délai. Livrer avec 23 % d'erreurs sans analyse préalable (A) peut rendre le système réellement inutilisable dans des zones critiques. Attendre la correction administrative (C) peut prendre des années dans certains contextes.`,
},

{ id:"EA-040", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  question:`Votre organisation est certifiée ISO 9001. Lors d'un audit interne, l'auditeur identifie que votre équipe Agile ne documente pas les non-conformités de produit selon les exigences du §8.7 de la norme (contrôle des éléments de sortie non conformes). L'équipe Agile argumente que "les bugs sont gérés dans Jira" et qu'une documentation ISO supplémentaire est bureaucratique et contraire à l'esprit Agile. Quelle est votre position ?`,
  options:[
    `A. Soutenir l'équipe Agile — l'ISO 9001 est conçue pour les organisations traditionnelles et n'est pas compatible avec les pratiques Agile modernes.`,
    `B. Soutenir l'auditeur — l'ISO 9001 est une obligation contractuelle et les équipes Agile doivent s'y conformer intégralement.`,
    `C. Faciliter une discussion entre l'équipe Agile et l'auditeur pour trouver une solution qui satisfait l'esprit de l'exigence §8.7 (traçabilité et traitement des non-conformités) sans ajouter de bureaucratie inutile : Jira peut servir de registre des non-conformités si les champs requis sont configurés correctement (nature de la non-conformité, décision de traitement, responsable, vérification) ; proposer une adaptation de l'outil existant plutôt qu'une documentation parallèle.`,
    `D. Demander une dérogation ISO pour les équipes Agile — les organismes de certification accordent généralement des exceptions aux pratiques modernes de développement.`,
  ],
  correct:2,
  explication:`La réponse C est correcte. L'ISO 9001:2015 est conçue de façon orientée résultats, pas prescriptive sur les outils — ce qui la rend compatible avec l'Agile si les exigences de traçabilité sont satisfaites dans les outils utilisés. Jira peut parfaitement servir de registre des non-conformités si les champs appropriés sont configurés. La solution optimale satisfait à la fois l'esprit ISO (traçabilité, traitement formel des non-conformités) et l'esprit Agile (outils intégrés, pas de bureaucratie parallèle). Les dérogations ISO (D) n'existent pas pour ce type de situation.`,
},

{ id:"EA-041", domaine:"Environnement d'affaires", approche:"Prédictif", type:"standard",
  question:`Vous êtes directeur de programme d'un programme de numérisation des services publics dans un pays émergent (88 M€, 5 ans). Un audit de la Cour des Comptes nationale publie un rapport critique du programme, pointant des "résultats insuffisants par rapport aux investissements consentis" et des "processus de gouvernance opaques". Le rapport contient 3 recommandations : publication trimestrielle des indicateurs de performance, audit indépendant annuel, et consultation des citoyens bénéficiaires. Comment répondez-vous ?`,
  options:[
    `A. Contester publiquement le rapport de la Cour des Comptes — les critiques sont excessives et nuisent à la réputation du programme.`,
    `B. Accepter les 3 recommandations et les mettre en œuvre rapidement, même si elles représentent une charge supplémentaire : les recommandations de la Cour des Comptes sont des mesures de redevabilité légitimes pour un programme financé par des fonds publics. Publier rapidement un plan d'action de mise en œuvre des 3 recommandations avec des échéances précises. Transformer la situation en opportunité : un programme qui répond positivement à la Cour des Comptes démontre sa maturité de gouvernance.`,
    `C. Mettre en œuvre les recommandations de façon minimale pour satisfaire formellement la Cour des Comptes sans réel changement de pratique.`,
    `D. Demander un délai de 12 mois pour évaluer l'impact des recommandations sur le programme avant de les mettre en œuvre.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Les recommandations de la Cour des Comptes sur un programme public sont des obligations de redevabilité non négociables — les contester (A) ou les appliquer superficiellement (C) dégraderait davantage la confiance publique. Les 3 recommandations (indicateurs publics, audit indépendant, consultation citoyenne) sont des bonnes pratiques de gouvernance de programme public que tout programme sérieux devrait pratiquer. La réponse proactive et positive à la Cour des Comptes est à la fois éthiquement correcte et stratégiquement intelligente pour la réputation du programme.`,
},

{ id:"EA-042", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  question:`Vous êtes chef de projet dans une startup B2B SaaS. Votre meilleur client (représentant 38 % de votre MRR) demande une fonctionnalité très spécifique à son secteur, non alignée avec votre vision produit généraliste. Il menace de quitter si vous ne développez pas cette fonctionnalité dans les 3 prochains mois. Le développement représente 4 sprints. Quelle est votre analyse et votre recommandation à la direction ?`,
  options:[
    `A. Développer la fonctionnalité immédiatement — perdre 38 % du MRR serait catastrophique pour la startup.`,
    `B. Analyser la situation sous plusieurs angles avant de décider : (1) la fonctionnalité est-elle réellement spécifique à un seul client ou répond-elle à un besoin de marché plus large (potentiel de généralisation ?) ; (2) quel est le coût d'opportunité des 4 sprints (fonctionnalités non développées pour les autres clients) ; (3) quelle est la probabilité réelle de départ (bluff ou décision ferme ?) ; (4) quel impact sur votre vision produit et la dette technique. Présenter à la direction 3 options : développer (et pour qui ?), négocier un compromis (fonctionnalité partielle ou délai étendu), ou accepter le risque de départ tout en accélérant l'acquisition d'autres clients.`,
    `C. Refuser la fonctionnalité — un client qui représente 38 % du MRR crée une dépendance dangereuse et sa demande spécifique nuit à la cohérence produit.`,
    `D. Proposer au client de financer le développement de la fonctionnalité via un contrat de développement personnalisé — ainsi vous développez la fonctionnalité sans impact sur le budget produit.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. La décision de développer ou non une fonctionnalité client-spécifique dans un SaaS B2B est rarement simple. L'analyse multi-angles est indispensable avant toute décision : si la fonctionnalité est généralisable à d'autres clients du même secteur, c'est une décision stratégique différente que si elle est purement idiosyncratique. L'option D (financement client) est souvent une solution équilibrée qui mérite d'être explorée. Le développement immédiat (A) sans analyse peut aggraver la dépendance à un seul client. Le refus catégorique (C) peut être existentiellement risqué à court terme.`,
},

{ id:"EA-043", domaine:"Environnement d'affaires", approche:"Prédictif", type:"standard",
  question:`Vous êtes chef de projet d'un programme de construction de logements sociaux (95 M€, 42 mois) pour une collectivité territoriale. Six mois avant la livraison, une inspection révèle que 15 % des logements présentent des problèmes d'humidité liés à une isolation insuffisante des façades. Le coût de correction est estimé à 3,2 M€. L'entrepreneur principal argue que les plans approuvés par le maître d'œuvre étaient conformes aux normes en vigueur mais que les normes ont évolué entre l'approbation des plans et la réalisation. Quelle est votre analyse ?`,
  options:[
    `A. Faire supporter l'intégralité du coût à l'entrepreneur — les problèmes d'humidité sont un défaut de construction qu'il doit corriger à ses frais.`,
    `B. Analyser la chronologie réglementaire : si les normes ont effectivement évolué APRÈS l'approbation des plans, l'entrepreneur peut légitimement invoquer une modification réglementaire en cours de projet (clause équivalente aux Changed Conditions). Si les plans respectaient les normes au moment de leur approbation, la responsabilité est partagée entre le maître d'œuvre (qui aurait dû adapter les plans aux nouvelles normes lors des révisions), et potentiellement la collectivité (qui n'a pas intégré la mise à jour normative dans la commande). Conduire une analyse contractuelle et juridique avant d'attribuer les responsabilités et les coûts.`,
    `C. Accepter les logements avec les problèmes d'humidité et prévoir leur correction dans le budget de maintenance — retarder la livraison de 6 mois aurait un coût social important.`,
    `D. Faire supporter le coût au maître d'œuvre — c'est lui qui a approuvé les plans et il aurait dû anticiper l'évolution des normes.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Une évolution normative en cours de projet est précisément le type de situation qui nécessite une analyse contractuelle rigoureuse avant d'attribuer des responsabilités. La chronologie est clé : normes évoluées avant ou après l'approbation des plans ? La maîtrise d'œuvre avait-elle connaissance de l'évolution ? Le contrat prévoyait-il l'adaptation aux nouvelles normes ? Les réponses à ces questions déterminent la répartition des responsabilités et des coûts entre les parties. Attribuer unilatéralement le coût à une partie (A, D) sans analyse contractuelle expose à des contentieux coûteux.`,
},

{ id:"EA-044", domaine:"Environnement d'affaires", approche:"Agile", type:"standard",
  question:`Vous êtes Scrum Master dans une organisation qui déploie l'Agile à grande échelle. Votre équipe est la plus performante du programme (meilleure vélocité, taux de défauts le plus faible, satisfaction client la plus élevée). Le directeur du programme vous demande de "dupliquer le modèle de votre équipe" dans les 4 autres équipes moins performantes. Comment répondez-vous à cette demande ?`,
  options:[
    `A. Créer immédiatement un manuel des pratiques de votre équipe et le distribuer aux 4 autres équipes.`,
    `B. Expliquer au directeur que la performance de l'équipe n'est pas uniquement due à ses pratiques formelles mais à une combinaison de facteurs : compétences individuelles, dynamique de groupe construite sur 18 mois, contexte fonctionnel, et relation avec le Product Owner. Proposer une approche d'accompagnement plutôt que de duplication : organiser des sessions d'observation et d'échange entre les équipes (pas un transfert de manuel), identifier avec chaque équipe moins performante ses causes spécifiques de sous-performance et les pratiques adaptées à son contexte — ce qui fonctionne dans un contexte ne se transpose pas mécaniquement.`,
    `C. Proposer de déplacer certains membres de votre équipe dans les autres équipes pour "contaminer" positivement leur culture.`,
    `D. Documenter toutes les pratiques de votre équipe de façon très détaillée pour permettre une implémentation identique dans les autres équipes.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. La performance d'une équipe Agile est un système socio-technique complexe qui ne se réduit pas à ses pratiques formelles. La "duplication de modèle" (copy-paste de pratiques) est un anti-pattern connu — elle ignore les spécificités de contexte, les dynamiques humaines et les causes réelles de sous-performance de chaque équipe. L'approche d'accompagnement différencié (observation, échange, diagnostic des causes spécifiques) est plus efficace et respecte l'auto-organisation de chaque équipe. Déplacer des membres (C) peut être pertinent dans certains cas mais n'est pas une solution systémique.`,
},

// ── PERSONNES supplémentaires ────────────────────────────────────

{ id:"P-051", domaine:"Personnes", approche:"Prédictif", type:"standard",
  question:`Dans un projet international, votre équipe comprend des membres de 5 nationalités différentes. Lors d'une revue critique, vous observez que les membres japonais et coréens acquiescent systématiquement aux propositions du manager français senior, même en cas de désaccord evident. Cette dynamique conduit à des décisions sous-optimales. Comment améliorez-vous ce processus de prise de décision ?`,
  options:[
    `A. Demander aux membres japonais et coréens d'adopter le style de communication direct occidental — c'est la norme professionnelle internationale.`,
    `B. Introduire des processus de décision qui neutralisent la pression hiérarchique : votes anonymes écrits, consultations individuelles préalables aux réunions, techniques de "six chapeaux de de Bono" pour structurer les contributions indépendamment du statut, et créer explicitement des espaces privés (1-1 avec le chef de projet) pour collecter les vraies positions avant les décisions importantes.`,
    `C. Retirer le manager français senior des réunions de prise de décision pour éliminer la dynamique de pouvoir.`,
    `D. Accepter la situation — les différences culturelles de communication font partie de la réalité des équipes internationales.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Les cultures à forte distance hiérarchique (Japon, Corée) ont tendance à éviter les désaccords publics avec l'autorité — ce n'est pas de la faiblesse mais un style de communication culturellement ancré. Les techniques de décision anonymes (votes, consultations préalables) créent des espaces où toutes les positions peuvent s'exprimer authentiquement. L'adaptation unilatérale (A) méconnaît les dynamiques culturelles. Retirer le manager (C) n'est pas réaliste. Accepter (D) perpétue des décisions sous-optimales.`,
},

{ id:"P-052", domaine:"Personnes", approche:"Agile", type:"standard",
  question:`Votre équipe Scrum de 7 développeurs est très performante depuis 14 mois. Le CEO annonce que l'organisation va adopter SAFe (Scaled Agile Framework) pour aligner 6 équipes sur un programme commun. Votre équipe devra adapter ses pratiques au nouveau cadre SAFe. Plusieurs membres expriment de la résistance : "SAFe est bureaucratique, on va perdre notre agilité". Comment facilitez-vous cette transition ?`,
  options:[
    `A. Imposer SAFe immédiatement — la décision est prise au niveau direction et l'équipe doit s'adapter.`,
    `B. Reconnaître la préoccupation légitime de l'équipe (SAFe ajoute effectivement de la structure) et faciliter une compréhension nuancée : (1) expliquer les raisons du passage à SAFe (coordination entre 6 équipes, bénéfices attendus) ; (2) identifier les pratiques actuelles de l'équipe qui seront préservées dans SAFe vs celles qui changeront ; (3) impliquer l'équipe dans la personnalisation de l'implémentation SAFe (SAFe recommande une adaptation contextuelle) ; (4) planifier une montée en compétences progressive — la transition vers SAFe avec accompagnement est moins perturbatrice que sans.`,
    `C. Laisser l'équipe continuer ses pratiques actuelles et rejoindre SAFe de façon minimale — préserver la performance d'une équipe qui fonctionne bien.`,
    `D. Proposer au CEO d'exempter votre équipe de SAFe car elle est déjà performante — SAFe est pour les équipes qui ont des problèmes de coordination.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. La résistance de l'équipe à SAFe est une réaction normale à un changement significatif — elle doit être traitée avec compréhension et information, pas ignorée ni imposée brutalement. La transparence sur les raisons du changement, l'implication dans l'adaptation (SAFe est un cadre flexible, pas un dogme rigide) et la montée en compétences progressive réduisent la perturbation. Exempter une équipe (D) d'un cadre organisationnel crée une incohérence systémique problématique. La participation minimale (C) compromet l'objectif de coordination entre équipes.`,
},

{ id:"P-053", domaine:"Personnes", approche:"Hybride", type:"standard",
  question:`Vous gérez un projet de développement d'un nouveau produit dans une PME de 80 personnes. Votre équipe projet comprend 6 membres, dont 2 qui travaillent à temps partiel sur votre projet (50 % chacun) et gèrent d'autres responsabilités opérationnelles. Régulièrement, des urgences opérationnelles les retirent de votre projet plusieurs jours sans préavis. Comment gérez-vous cette dépendance à des ressources partagées ?`,
  options:[
    `A. Accepter la situation — dans une PME, les ressources partagées sont une réalité à gérer avec flexibilité.`,
    `B. Quantifier l'impact des interruptions sur le projet (délais générés, reprises nécessaires) et présenter cette analyse au dirigeant de la PME ; négocier un accord formel de disponibilité minimale (ex : 3 jours/semaine garantis, préavis de 48h pour les interruptions non urgentes) ; adapter le planning pour concentrer les tâches critiques sur les périodes de disponibilité assurée ; identifier pour chaque ressource partagée un backup partiel dans le reste de l'équipe pour les tâches les moins critiques.`,
    `C. Demander au dirigeant de la PME d'affecter les 2 membres à 100 % sur votre projet jusqu'à la fin — la qualité des livrables requiert une disponibilité complète.`,
    `D. Restructurer le planning pour que les 2 membres partiels n'aient que des tâches non critiques — ainsi leurs interruptions n'impactent pas le chemin critique.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Les ressources partagées dans une PME sont une réalité mais leur gestion doit être proactive. La quantification de l'impact (délais réels générés par les interruptions) transforme le problème flou en problème chiffré que le dirigeant peut comprendre et arbitrer. L'accord formel de disponibilité minimale et le préavis réduisent significativement les perturbations. L'affectation à 100 % (C) peut ne pas être réalisable dans le contexte opérationnel de la PME. La restructuration du planning (D) est une mitigation partielle mais ne résout pas le problème de fond.`,
},

{ id:"P-054", domaine:"Personnes", approche:"Agile", type:"standard",
  question:`Lors d'une rétrospective de sprint, un membre de l'équipe soulève un problème grave : un autre membre copie régulièrement du code open source sans respecter les licences (utilisation de code GPL dans un produit commercial propriétaire). Il a des preuves. Le membre incriminé est présent dans la réunion. Comment gérez-vous cette situation dans l'immédiat et ensuite ?`,
  options:[
    `A. Traiter la question immédiatement en rétrospective — toutes les problèmes d'équipe doivent être résolus collectivement.`,
    `B. Interrompre brièvement la rétrospective sur ce sujet : remercier le signalement, reconnaître la gravité du sujet (risque légal réel pour l'entreprise), indiquer que ce point sera traité en dehors de la rétrospective pour respecter le processus approprié. En dehors : vérifier les faits avec le responsable technique, escalader au management et au service juridique (violation de licence GPL dans un produit commercial est un risque légal sérieux), traiter le cas individuellement avec le membre concerné selon le processus RH approprié — pas en réunion d'équipe.`,
    `C. Ignorer l'incident en rétrospective et traiter la question uniquement si le risque légal est confirmé par le juridique.`,
    `D. Demander au membre incriminé de s'expliquer devant l'équipe immédiatement — la transparence en équipe est un principe Agile fondamental.`,
  ],
  correct:1,
  explication:`La réponse B est correcte. Une violation de licence logicielle est un risque légal sérieux pour l'entreprise — pas un sujet de rétro d'équipe. La rétrospective n'est pas le forum approprié pour traiter des questions disciplinaires ou légales. Interrompre la rétro sur ce sujet et le traiter par les canaux appropriés (management, juridique, RH) est à la fois professionnel et respectueux de toutes les parties. La confrontation publique (D) en rétrospective peut aggraver la situation et créer un environnement hostile. Ignorer (C) expose l'entreprise à un risque légal non traité.`,
},
